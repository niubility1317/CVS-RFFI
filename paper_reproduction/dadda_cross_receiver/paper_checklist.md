...
| WiSig subset | Section V-A: six transmitters, twelve receivers, four days; each receiver domain is described as 4000 samples | `build_manysig_task_datasets` validates counts and supports `paper_domain_sample_count` | synthetic ManySig fixture test | Implemented validation and domain sample-count control |
