...
| Multiscale `G_m` | Fig. 4: four branches `2x1`, `2x1+1x3`, `2x1+1x5`, `AvgPool+2x1` | `DADDAMultiscaleExtractor` | model shape test | Implemented as 1-D IQ approximation of the four-branch design |
