...
OUT_ROOT="${OUT_ROOT:-${ROOT}/runs/cvs_qknnv42_extreme_light_20new_features_20260714}"
LOG_ROOT="${LOG_ROOT:-${ROOT}/logs/cvs_qknnv42_extreme_light_20new_features_20260714}"
...
NEW_TX_IDS="${NEW_TX_IDS:-1-16,1-18,20-12,20-14,13-3,2-13,11-20,14-20,4-11,18-1,19-7,13-14,19-14,2-15,10-1,19-20,20-3,18-8,11-7,20-5}"
SEED="${SEED:-713101}"
GPUS="${GPUS:-0,1,2}"
DRY_RUN="${DRY_RUN:-0}"
