#!/usr/bin/env python3
"""CLI for the truth-last D92 QIC Hard9+K1 analyzer."""
...
from cvsrffi.stage2_d92_qic_hard9_k1_analysis import (  # noqa: E402
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="Analyze one immutable D92 QIC Hard9+K1 run after truth-sidecar scoring."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = analyze_d92_qic_hard9_k1(
