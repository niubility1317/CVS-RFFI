#!/usr/bin/env bash
# Generated locally for next64cg from next64cf after live dual-idle monitor gate; Phase1 seeds +1000 from next64cf; Phase2 deferred for route-duplication/local-hook repair.
set -euo pipefail

ROOT="${ROOT:-/home/szu2070436088/2510044040/CV-SincNet}"
PYTHON="${PYTHON:-/home/szu2070436088/.conda/envs/CVS-RFFI/bin/python}"
RUN_ID="${RUN_ID:-stage2_spaceborne_next64cg_20260621_012031}"
...
declare -a CAND_ID=(S2N100_GPU0_A_MSSL_B0_CEN51_R04_refresh_A S2N100_GPU1_A_MSSL_B4_MSSL_MetaProtoDG_A S2N100_GPU2_A_MSSL_B2_MSSL_TeacherFree_A S2N100_GPU3_A_MSSL_B3_MSSL_ProtoGate_A S2N100_GPU4_A_MSSL_B1_MSSL_Udom_split_audit_A S2N100_GPU5_A_MSSL_B5_MSSL_SatGate_A S2N100_GPU6_A_MSSL_B0_CEN51_R04_refresh_A S2N100_GPU7_A_MSSL_B3_MSSL_ProtoGate_A S2N100_GPU0_B_STAGE2A_FRONTIER_PROTO20_Q80_B S2N100_GPU0_C_STAGE2A_FRONTIER_PROTO20_Q90_C S2N100_GPU0_D_S2B_K1_P40_Q70_LOWFAR_D S2N100_GPU0_E_S2B_K2_P40_Q70_LOWFAR_E S2N100_GPU0_F_S2B_K4_P40_Q70_STRICT_F S2N100_GPU0_G_STAGE2A_FPR95_PROTO60_Q80_G S2N100_GPU0_H_S2B_K2_P60_Q80_BAL_H S2N100_GPU1_B_STAGE2A_FRONTIER_PROTO60_Q70_B S2N100_GPU1_C_S2B_K1_P60_Q70_STRICT_C S2N100_GPU1_D_S2B_K2_P60_Q70_LOWFAR_D S2N100_GPU1_E_S2B_K4_P60_Q70_LOWFAR_E S2N100_GPU1_F_S2B_K8_P60_Q70_OVERFIT_NEG_F S2N100_GPU1_G_STAGE2A_LOWPROTO_NEG_Q60_G S2N100_GPU1_H_S2B_LOWPROTO_K1_NEG_Q60_H S2N100_GPU2_B_STAGE2A_CLEAR_FRONTIER_Q80_B S2N100_GPU2_C_STAGE2A_LOWELEV_FRONTIER_Q80_C S2N100_GPU2_D_STAGE2A_RAIN_FRONTIER_Q80_D S2N100_GPU2_E_STAGE2A_STORM_FRONTIER_Q80_E S2N100_GPU2_F_STAGE2A_MIXED_FRONTIER_Q80_F S2N100_GPU2_G_S2B_MIXED_K1_LOWFAR_Q80_G S2N100_GPU2_H_S2B_MIXED_K2_STRICT_Q80_H S2N100_GPU3_B_S2B_CLEAR_K1_LOWFAR_Q80_B S2N100_GPU3_C_S2B_LOWELEV_K1_LOWFAR_Q80_C S2N100_GPU3_D_S2B_RAIN_K1_LOWFAR_Q80_D S2N100_GPU3_E_S2B_STORM_K1_LOWFAR_Q80_E S2N100_GPU3_F_S2B_CLEARLOW_K2_BAL_Q70_F S2N100_GPU3_G_S2B_RAINSTORM_K2_BAL_Q70_G S2N100_GPU3_H_S2B_ALLSCEN_K2_STRICT_Q90_H S2N100_GPU4_B_STAGE2A_PROTO100_Q80_CONFIRM_B S2N100_GPU4_C_STAGE2A_PROTO140_Q70_AUROC_C S2N100_GPU4_D_S2B_K1_P100_Q80_LOWFAR_D S2N100_GPU4_E_S2B_K2_P100_Q80_LOWFAR_E S2N100_GPU4_F_S2B_K4_P100_Q80_BAL_F S2N100_GPU4_G_STAGE2A_K5_HARM_LOWPROTO_G S2N100_GPU4_H_STAGE2A_K20_HARM_FRONTIER_H S2N100_GPU5_B_S2B_K1_P140_Q60_FPR95_B S2N100_GPU5_C_S2B_K2_P140_Q60_FPR95_C S2N100_GPU5_D_S2B_K4_P140_Q60_LOWFAR_D S2N100_GPU5_E_STAGE2A_PROTO160_Q60_FPR95_E S2N100_GPU5_F_S2B_K1_P160_Q60_STRICT_F S2N100_GPU5_G_S2B_K2_P160_Q70_LOWFAR_G S2N100_GPU5_H_S2B_K4_P160_Q70_STRICT_H S2N100_GPU6_B_STAGE2A_TXRX_PROTO60_Q70_B S2N100_GPU6_C_S2B_TXRX_K1_P60_Q70_C S2N100_GPU6_D_S2B_TXRX_K2_P60_Q70_D S2N100_GPU6_E_S2B_TXRX_K4_P60_Q70_E S2N100_GPU6_F_STAGE2A_HARDONLY_PROTO80_Q80_F S2N100_GPU6_G_S2B_HARDONLY_K2_Q80_LOWFAR_G S2N100_GPU6_H_S2B_HARDONLY_K4_Q80_STRICT_H S2N100_GPU7_B_STAGE2A_UNKNOWN_GUARD_PROTO80_B S2N100_GPU7_C_S2B_UNKNOWN_GUARD_K1_Q70_C S2N100_GPU7_D_S2B_UNKNOWN_GUARD_K2_Q70_D S2N100_GPU7_E_S2B_UNKNOWN_GUARD_K4_Q70_E S2N100_GPU7_F_STAGE2A_HIGHFAR_REFUTE_PROTO20_Q40_F S2N100_GPU7_G_STAGE2A_K10_HARM_NEG_STRICT_G S2N100_GPU7_H_S2B_FINAL_FRONTIER_K2_P120_Q80_H)
...
declare -a META_SEED=(73000 73013 73026 73039 73052 73065 73078 73091 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000 6000)
...
if [[ "${PHASE1_LANE_ACTIVE}" == "1" ]]; then
  for i in "${!CAND_ID[@]}"; do
    if [[ "${CAND_LANE[$i]:-}" == "phase1" ]]; then
      ...
      event_row "${CAND_ID[$i]}" "DEFERRED_RETRY_CAPACITY" "gpu=${CAND_GPU[$i]}" "lane=phase1" "reason=phase1_lane_active_or_capacity_retry;exact_retry=RUN_ID=${RUN_ID}_phase1_retry PHASE1_LANE_ACTIVE=0 PHASE2_LANE_ACTIVE=1 bash ${ROOT}/code/scripts/launch_stage2_optimizer_20260621_012031_next64cg.sh"
    fi
  done
fi
...
if [[ "${PHASE2_LANE_ACTIVE}" == "1" ]]; then
  for i in "${!CAND_ID[@]}"; do
    if [[ "${CAND_LANE[$i]:-}" == "phase2" ]]; then
      ...
      event_row "${CAND_ID[$i]}" "DEFERRED_RETRY_CAPACITY" "gpu=${CAND_GPU[$i]}" "lane=phase2" "reason=phase2_lane_active_or_capacity_retry;exact_retry=RUN_ID=${RUN_ID}_phase2_retry PHASE1_LANE_ACTIVE=1 PHASE2_LANE_ACTIVE=0 bash ${ROOT}/code/scripts/launch_stage2_optimizer_20260621_012031_next64cg.sh"
    fi
  done
fi
...
if [[ "${PHASE2_LOCAL_PATCH_REQUIRED}" == "1" ]]; then
  for i in "${!CAND_ID[@]}"; do
    if [[ "${CAND_LANE[$i]:-}" == "phase2" ]]; then
      ...
      event_row "${CAND_ID[$i]}" "DEFERRED_RETRY_LOCAL_VERIFY" "gpu=${CAND_GPU[$i]}" "lane=phase2" "reason=route_duplication_repair_required;exact_retry=RUN_ID=${RUN_ID}_phase2_repaired PHASE1_LANE_ACTIVE=1 PHASE2_LANE_ACTIVE=0 bash ${ROOT}/code/scripts/launch_stage2_optimizer_20260621_012031_next64cg.sh"
    fi
  done
fi
