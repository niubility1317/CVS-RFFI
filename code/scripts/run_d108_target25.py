#!/usr/bin/env python3
"""Prepare, smoke, shard, merge, validate, truth-build, or score D108 Target25."""
...
from cvsrffi.stage2_d108_target25 import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "prepare":
        result = prepare_d108_target25_run(
        ...
        result = smoke_d108_target25_prepared_state(
        ...
        result = validate_d108_target25_prediction_manifest(
        ...
        result = build_d108_target25_truth_catalog(
            prediction_manifest_path=args.prediction_manifest,
            expected_prediction_manifest_file_sha256=args.prediction_manifest_sha256,
            plan_manifest_path=args.plan_manifest,
            expected_plan_file_sha256=args.plan_manifest_sha256,
