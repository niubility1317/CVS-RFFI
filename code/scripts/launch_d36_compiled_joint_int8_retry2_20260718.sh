...
OUTPUT="$RUN/output/support_screen_retry2"
LOG_ROOT="$PROJECT/logs/d36_compiled_joint_int8_20260718"
LOG="$LOG_ROOT/support_screen_retry2.log"
PID_FILE="$RUN/support_screen_retry2.pid"
PYCACHE_ROOT="$RUN/pycache_support_screen_retry2"
...
pid=$!
printf '%s\n' "$pid" >"$PID_FILE"
echo "D36_RETRY2_PID=$pid"
echo "D36_RETRY2_GPU=$GPU"
echo "D36_RETRY2_LOG=$LOG"
echo "D36_RETRY2_OUTPUT=$OUTPUT"
