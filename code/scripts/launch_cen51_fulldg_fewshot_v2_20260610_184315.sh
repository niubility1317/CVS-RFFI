...
RUN_ID="${RUN_ID:-cen51_fulldg_fewshot_v2_20260610_184315}"
...
run_candidate FS005_HINGE6_SATMIN_1337 CEN51_FDLOWV2_FS005_HINGE6_SATMIN_1337 5 0 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS005_HINGE6_SATMIN_2028 CEN51_FDLOWV2_FS005_HINGE6_SATMIN_2028 5 1 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS005_IDFIRST_LATE_2029 CEN51_FDLOWV2_FS005_IDFIRST_LATE_2029 5 2 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS005_RX8_FLOOR_2028 CEN51_FDLOWV2_FS005_RX8_FLOOR_2028 5 3 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS010_IDFIRST_LATE_2028 CEN51_FDLOWV2_FS010_IDFIRST_LATE_2028 10 4 \
  --batch_size \
  128 \
  --epochs \
  200 \
...
run_candidate FS010_IDFIRST_LATE_2029 CEN51_FDLOWV2_FS010_IDFIRST_LATE_2029 10 5 \
  --batch_size \
  128 \
  --epochs \
  200 \
...
run_candidate FS010_RXGUARD_SATFLOOR_2028 CEN51_FDLOWV2_FS010_RXGUARD_SATFLOOR_2028 10 6 \
  --batch_size \
  128 \
  --epochs \
  200 \
...
run_candidate FS010_BAL_VAL_2030 CEN51_FDLOWV2_FS010_BAL_VAL_2030 10 0 \
  --batch_size \
  128 \
  --epochs \
  200 \
...
run_candidate FS020_RIEIFD_LIGHT_2028 CEN51_FDLOWV2_FS020_RIEIFD_LIGHT_2028 20 0 \
  --batch_size \
  256 \
  --epochs \
  205 \
...
run_candidate FS020_RIEIFD_FDGATE_B_2029 CEN51_FDLOWV2_FS020_RIEIFD_FDGATE_B_2029 20 1 \
  --batch_size \
  256 \
  --epochs \
  205 \
...
run_candidate FS020_RXFLOOR_LIGHT_1337 CEN51_FDLOWV2_FS020_RXFLOOR_LIGHT_1337 20 2 \
  --batch_size \
  256 \
  --epochs \
  205 \
...
run_candidate FS030_RXFLOOR_CAP_2028 CEN51_FDLOWV2_FS030_RXFLOOR_CAP_2028 30 3 \
  --batch_size \
  256 \
  --epochs \
  210 \
...
run_candidate FS030_RXFLOOR_CAP_2029 CEN51_FDLOWV2_FS030_RXFLOOR_CAP_2029 30 4 \
  --batch_size \
  256 \
  --epochs \
  210 \
...
run_candidate FS030_IDCAP_RELAX_2030 CEN51_FDLOWV2_FS030_IDCAP_RELAX_2030 30 5 \
  --batch_size \
  256 \
  --epochs \
  210 \
...
run_candidate FS050_CAP_RELAX_2028 CEN51_FDLOWV2_FS050_CAP_RELAX_2028 50 1 \
  --batch_size \
  256 \
  --epochs \
  215 \
...
run_candidate FS050_CAP_RELAX_PLUS_2029 CEN51_FDLOWV2_FS050_CAP_RELAX_PLUS_2029 50 2 \
  --batch_size \
  256 \
  --epochs \
  215 \
