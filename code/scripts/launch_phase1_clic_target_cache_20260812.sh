...
# Build exactly one immutable registered/unknown target LEO-weak cache.  This
# offline Phase1 operation does not open any C/G checkpoint, prediction, truth
# scorer, support set, or target metric.
RUN_ID="phase1_clic_target_confirmation_20260812_v1"
PROJECT_ROOT="/home/szu2070436088/2510044040/CV-SincNet"
CODE_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
PYTHON="/home/szu2070436088/.conda/envs/CVS-RFFI/bin/python"
SPEC="${CODE_ROOT}/configs/phase1_clic_target_confirmation_20260812_v1.json"
