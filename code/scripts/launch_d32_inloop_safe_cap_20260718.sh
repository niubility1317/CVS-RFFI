...
RUN="$PROJECT/runs/d32_inloop_safe_cap_20260718"
OUTPUT="$RUN/output/support_screen_v2"
LOG_ROOT="$PROJECT/logs/d32_inloop_safe_cap_20260718"
...
EXPECTED_RUNNER_SHA256=f49f3257b52122f695748241249aee75b51bd916b853e8ecd7f98d74474a93be
