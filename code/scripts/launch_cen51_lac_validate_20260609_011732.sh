...
RUN_ID="${RUN_ID:-cen51_lac_validate_20260609_011732}"
...
run_candidate CEN51_LAC01_FS005_lac_primary CEN51_LAC01_FS005_lac_primary_r010 5 4 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
...
run_candidate CEN51_LAC02_FS010_lac_primary CEN51_LAC02_FS010_lac_primary_r010 10 5 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.45 \
  --sat_view_schedule \
  '1@0.35:clear_leo,mixed_orbit;135@0.45:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.0 \
  --sat_cons_start_epoch \
  999 \
...
run_candidate CEN51_LAC03_FS020_lac_primary CEN51_LAC03_FS020_lac_primary_r010 20 6 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.55 \
  --sat_view_schedule \
  '1@0.45:clear_leo,mixed_orbit;145@0.60:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --use_sat_consistency \
  --lambda_sat_cons \
  0.001 \
  --sat_cons_start_epoch \
...
run_candidate CEN51_LAC04_FS030_lac_primary CEN51_LAC04_FS030_lac_primary_r010 30 7 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.6 \
  --sat_view_schedule \
  '1@0.50:clear_leo,mixed_orbit;145@0.68:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --use_sat_consistency \
  --lambda_sat_cons \
  0.0015 \
  --sat_cons_start_epoch \
...
run_candidate CEN51_LAC05_FS050_lac_primary CEN51_LAC05_FS050_lac_primary_r010 50 0 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.72 \
  --sat_view_schedule \
  '1@0.60:clear_leo,mixed_orbit;140@0.82:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --use_sat_consistency \
  --lambda_sat_cons \
  0.0025 \
  --sat_cons_start_epoch \
...
run_candidate CEN51_LAC06_FS005_sat_min_ablate CEN51_LAC06_FS005_sat_min_ablate_r010 5 1 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
...
run_candidate CEN51_LAC07_FS010_rx_floor_probe CEN51_LAC07_FS010_rx_floor_probe_r010 10 2 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.38 \
  --sat_view_schedule \
  '1@0.30:clear_leo,mixed_orbit;145@0.40:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.0 \
  --sat_cons_start_epoch \
  999 \
...
run_candidate CEN51_LAC08_FS020_sat_reentry_probe CEN51_LAC08_FS020_sat_reentry_probe_r010 20 3 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.6 \
  --sat_view_schedule \
  '1@0.45:clear_leo,mixed_orbit;145@0.70:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --use_sat_consistency \
  --lambda_sat_cons \
  0.0015 \
  --sat_cons_start_epoch \
