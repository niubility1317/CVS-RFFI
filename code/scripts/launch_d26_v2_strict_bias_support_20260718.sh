...
EXPECTED_RUNNER_SHA256=5adfd865bde4f896edec848adda36d6a98f5de8ad4c70fc35c6780dc51031065
EXPECTED_D26_CORE_SHA256=9d7d1ef87fed216aa35c5dee056a067da884f95af3b233d96d05eab9d6da34d6
...
CUDA_VISIBLE_DEVICES="$GPU" PYTHONUNBUFFERED=1 PYTHONPYCACHEPREFIX="$PYCACHE_ROOT" nohup "$PYTHON" \
  ...
  --candidate-set d26_v2_strictbias \
  >"$LOG" 2>&1 &
