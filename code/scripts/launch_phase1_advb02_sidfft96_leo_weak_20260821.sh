...
RUN_ID="${RUN_ID:-phase1_advb02_sidfft96_leo_weak_20260821_v1}"
...
GPU_S3="${GPU_S3:-1}"
DRY_RUN="${DRY_RUN:-0}"
ONLY="${ONLY:-P0,S0,S1,S2,S3}"

readonly MATRIX="P0,S0,S1,S2,S3"
...
readonly P0_DIR="${RUNS_ROOT}/P0_SPECTRAL_AUDIT"
readonly SID_MASK_PATH="${P0_DIR}/sid_mask.npz"
...
selected P0 && run_p0
selected S0 && run_s0
selected S1 && run_training_row S1 S1_CENTER center "${GPU_S1}"
selected S2 && run_training_row S2 S2_PHASE phase "${GPU_S2}"
selected S3 && run_training_row S3 S3_SIDFFT96 sid "${GPU_S3}"
