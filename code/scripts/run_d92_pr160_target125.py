#!/usr/bin/env python3
"""Prepare, smoke, shard, merge, truth-build, or score D92-Lite-PR160 Target125."""
...
from cvsrffi.stage2_d92_pr160_target125 import (  # noqa: E402
...
def _extractor(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("--extractor-runtime", type=Path, required=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "prepare":
        result = prepare_d92_pr160_target125_run(
            **method,
        ...
        result = smoke_d92_pr160_target125_prepared_state(
            **method,
            ...
            extractor_runtime_path=args.extractor_runtime,
            output_dir=args.output_dir,
        ...
        result = predict_d92_pr160_target125(
            **method,
            plan_manifest_path=args.plan_manifest,
            expected_plan_file_sha256=args.plan_manifest_sha256,
            context_manifest_path=args.context_manifest,
        ...
        result = validate_d92_pr160_prediction_manifest(
            **method,
        ...
        result = build_d92_pr160_truth_catalog(
            **method,
            prediction_manifest_path=args.prediction_manifest,
            expected_prediction_manifest_file_sha256=args.prediction_manifest_sha256,
            plan_manifest_path=args.plan_manifest,
        ...
        result = score_d92_pr160_target125(
            **method,
            prediction_manifest_path=args.prediction_manifest,
            expected_prediction_manifest_file_sha256=args.prediction_manifest_sha256,
