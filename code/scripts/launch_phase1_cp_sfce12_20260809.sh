...
COMMON=(
  ...
  --phase1_cp_sfce_frozen_mode true --cp_sfce_gamma 1 --max_grad_norm 5.0 --checkpoint_selection final_only --best_metric source_val_sat_hmean --phase1_source_val_selection_only true
...
launch_arm() {
  ...
  local -a arm_args
  case "${arm}" in
    C) arm_args=(--phase1_cp_sfce_enabled false --lambda_cp_sfce 0) ;;
    G) arm_args=(--phase1_cp_sfce_enabled true --lambda_cp_sfce 0.10) ;;
