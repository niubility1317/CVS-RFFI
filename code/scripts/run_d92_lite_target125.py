#!/usr/bin/env python3
"""Prepare, smoke, shard, merge, truth-build, or score D92-Lite Target125."""
...
from cvsrffi.stage2_d92_lite_target125 import (  # noqa: E402
    FORMAL_ISOLATION_ENV,
    build_d92_lite_target125_truth_catalog,
    predict_d92_lite_target125,
    prepare_d92_lite_target125_run,
    score_d92_lite_target125,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "prepare":
        result = prepare_d92_lite_target125_run(
            **method,
        ...
        result = smoke_d92_lite_target125_prepared_state(
            **method,
            ...
            output_dir=args.output_dir, row_index=args.row_index,
            scene_index=args.scene_index, device=args.device,
            feature_batch_size=args.feature_batch_size,
        )
    elif args.command == "predict-shard":
        result = predict_d92_lite_target125(
            **method,
            plan_manifest_path=args.plan_manifest,
            expected_plan_file_sha256=args.plan_manifest_sha256,
            context_manifest_path=args.context_manifest,
            expected_context_file_sha256=args.context_manifest_sha256,
            output_dir=args.output_dir, shard_index=args.shard_index,
            device=args.device, feature_batch_size=args.feature_batch_size,
        )
    elif args.command == "merge":
        result = predict_d92_lite_target125(
            **method, shard_manifest_paths=args.shard_manifest,
            output_dir=args.output_dir
        )
    elif args.command == "validate":
        result = validate_d92_lite_target125_prediction_manifest(
            **method,
        ...
        result = build_d92_lite_target125_truth_catalog(
            **method,
            prediction_manifest_path=args.prediction_manifest,
            expected_prediction_manifest_file_sha256=args.prediction_manifest_sha256,
            plan_manifest_path=args.plan_manifest,
        ...
        result = score_d92_lite_target125(
            **method,
            prediction_manifest_path=args.prediction_manifest,
            expected_prediction_manifest_file_sha256=args.prediction_manifest_sha256,
