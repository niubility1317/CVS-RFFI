...
RUN="$PROJECT/runs/d31_all_registered_suffix_20260718"
OUTPUT="$RUN/output/support_screen_v1"
LOG_ROOT="$PROJECT/logs/d31_all_registered_suffix_20260718"
...
EXPECTED_RUNNER_SHA256=282f79179f51f70bc9d30eafb8db43ed4859cc9faac7d51589a65c2e5c6e53d2
EXPECTED_D31_CORE_SHA256=db65762955bfcddee7ff22f5f154b142a654849a93eddf2a64e55e31cbdd0116
...
# Preserve the independently edited local diagnostic operator. D31 reuses the
# already verified remote B3 implementation and does not synchronize that file.
