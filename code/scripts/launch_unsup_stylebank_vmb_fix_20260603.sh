...
# Fixed one-new-run-per-GPU matrix for the domain-consistency -> StyleBank -> VMB bridge.
# F-series repair target: domain_unsup_pretrain must not freeze the CE/TX path.
# Hard FL contract: --wisig_train_ratio 0.1 --epochs 200 --fl_rounds 200 --fl_client_key receiver

ROOT="${ROOT:-/home/szu2070436088/2510044040/CV-SincNet}"
PYTHON="${PYTHON:-/home/szu2070436088/.conda/envs/CVS-RFFI/bin/python}"
NVIDIA_SMI_BIN="${NVIDIA_SMI_BIN:-nvidia-smi}"
RUN_ID="${RUN_ID:-20260603_215500_unsup_stylebank_vmb_fix}"
...
DOMAIN_CONSISTENCY=(
  ...
  --fl_domain_pretrain_train_scope all
  ...
  --domain_unsup_client_compact_weight 0.50
)
...
DOMAIN_METADATA=(
  ...
  --lambda_domain_unsup_pretrain 0.20
  --lambda_domain_unsup_metadata_ce 0.30
  --lambda_domain_unsup_var 0.05
  --domain_unsup_noise_std 0.01
  --domain_unsup_amp_jitter 0.03
  --domain_unsup_logit_cons_weight 0.10
...
REAL_MIX_DIAG=(
  ...
  --fl_style_real_mix_start_round 120
)
...
RUN_NAMES=(
  ...
  USBV_F3_stylebank_probe_r010
  USBV_F4_domain_stylebank_probe_fixed_r010
  USBV_F5_domain_stylebank_fishr_fixed_r010
  USBV_F6_domain_stylebank_fishr_mixstyle_fixed_r010
