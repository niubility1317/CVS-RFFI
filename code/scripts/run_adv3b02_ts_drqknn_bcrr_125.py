...
LAUNCHER_SCHEMA = "cvs.stage2.adv3b02.full125.artifact_validator.r2_affine_bcr2_zidtotal1_bindfix1"
...
def job_id(receiver: str, seed: int, k_shot: int, new_class_count: int) -> str:
    return f"adv3b02_r2_affine_bcr2_rx_{receiver}_s_{seed}_k_{k_shot}_n_{new_class_count}"
