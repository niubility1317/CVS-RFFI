...
RUN_ID="${RUN_ID:-cen51_riei_fd_shotaware_20260609_113800}"
...
run_candidate FS005_FORCE_GRLLOW_HINGE CEN51_RIEIFD_FS005_FORCE_GRLLOW_HINGE_seed2028 5 1 \
  --batch_size \
  128 \
  --epochs \
  150 \
...
run_candidate FS005_DOMSIDE_GRLLOW_L2 CEN51_RIEIFD_FS005_DOMSIDE_GRLLOW_L2_seed2028 5 2 \
  --batch_size \
  128 \
  --epochs \
  150 \
...
run_candidate FS010_CE_FN_L2 CEN51_RIEIFD_FS010_CE_FN_L2_seed2028 10 3 \
  --batch_size \
  128 \
  --epochs \
  160 \
...
run_candidate FS010_FORCE_GRLMID_L2 CEN51_RIEIFD_FS010_FORCE_GRLMID_L2_seed2028 10 4 \
  --batch_size \
  128 \
  --epochs \
  160 \
...
run_candidate FS010_DOMSIDE_GRLMID_L2 CEN51_RIEIFD_FS010_DOMSIDE_GRLMID_L2_seed2028 10 5 \
  --batch_size \
  128 \
  --epochs \
  160 \
...
run_candidate FS020_SHOTAWARE_CLEANBAL CEN51_RIEIFD_FS020_SHOTAWARE_CLEANBAL_seed2028 20 6 \
  --batch_size \
  128 \
  --epochs \
  175 \
...
run_candidate FS020_SHOTAWARE_SATGATE CEN51_RIEIFD_FS020_SHOTAWARE_SATGATE_seed2028 20 7 \
  --batch_size \
  128 \
  --epochs \
  175 \
  ...
  2 \
  --sat_view_schedule \
  1@0.14:clear_leo,mixed_orbit \
  --sat_train_scenarios \
  clear_leo,mixed_orbit

run_candidate FS030_SHOTAWARE_CLEANBAL CEN51_RIEIFD_FS030_SHOTAWARE_CLEANBAL_seed2028 30 0 \
  --batch_size \
  128 \
  --epochs \
  185 \
...
run_candidate FS030_SHOTAWARE_SATGATE CEN51_RIEIFD_FS030_SHOTAWARE_SATGATE_seed2028 30 1 \
  --batch_size \
  128 \
  --epochs \
  185 \
  ...
  2 \
  --sat_view_schedule \
  1@0.18:clear_leo,mixed_orbit \
  --sat_train_scenarios \
  clear_leo,mixed_orbit

run_candidate FS050_SHOTAWARE_CLEANBAL CEN51_RIEIFD_FS050_SHOTAWARE_CLEANBAL_seed2028 50 2 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS050_SHOTAWARE_SATGATE CEN51_RIEIFD_FS050_SHOTAWARE_SATGATE_seed2028 50 3 \
  --batch_size \
  128 \
  --epochs \
  195 \
