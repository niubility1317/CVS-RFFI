...
RUN="$PROJECT/runs/d26_compact_diag_20260718"
OUTPUT="$RUN/output/support_screen_v1"
LOG_ROOT="$PROJECT/logs/d26_compact_diag_20260718"
...
D26_CORE=code/cvsrffi/stage2_multimodal_compact_diag.py
...
EXPECTED_RUNNER_SHA256=4b664deff293571e44a86c3157f918146adda42e35167adb4d9836f2cbffcb52
EXPECTED_D26_CORE_SHA256=c03d2990a88b1526d40728fa616e4e4e6a43bc42c3e67e24388687aee35d6899
...
# This is the existing N607 operator actually used by the B3 control and the
# shared single-IQ FFT96/RF32 extraction.  It is hashed, not overwritten.
...
verify_sha256 "$D26_CORE" "$EXPECTED_D26_CORE_SHA256"
