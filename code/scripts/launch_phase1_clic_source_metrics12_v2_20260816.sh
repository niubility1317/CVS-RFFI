...
# Immutable v2 formal source-only completion.  This preserves the v1 frozen
# six-cache/twelve-forward/six-score/one-aggregate matrix exactly; only the
# new non-overwriting v2 run identity differs.  No performance value controls
# dispatch, stopping, retry, selection, revival, or promotion.
RUN_ID="phase1_clic_source_metrics_20260813_v2"
