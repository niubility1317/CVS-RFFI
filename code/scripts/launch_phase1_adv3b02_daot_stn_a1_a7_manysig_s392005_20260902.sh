...
RUN_ID="${RUN_ID:-phase1_adv3b02_daot_stn_a1_a7_manysig_s392005_20260902}"
...
echo "[DAOT-MATRIX] run_id=${RUN_ID} seed=${SEED} rows=7 source_pool=90000 validation=single_v_27000 target_per_scenario=168000 baseline=excluded_by_user"
