...
RUN="$PROJECT/runs/d27_perclass_bias_20260718"
OUTPUT="$RUN/output/support_screen_v1"
LOG_ROOT="$PROJECT/logs/d27_perclass_bias_20260718"
...
EXPECTED_RUNNER_SHA256=9bb0deff5fa896da54947a7505eceb47e03a9d05d1a0b3d31490df36d0d9fd6b
...
CUDA_VISIBLE_DEVICES="$GPU" PYTHONUNBUFFERED=1 PYTHONPYCACHEPREFIX="$PYCACHE_ROOT" nohup "$PYTHON" \
  ...
  --candidate-set d27_v1_perclassbias \
  >"$LOG" 2>&1 &
