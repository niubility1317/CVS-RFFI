...
RUN="$PROJECT/runs/d25_c3_diag_floor_20260718"
OUTPUT="$RUN/output/support_screen_v1"
LOG_ROOT="$PROJECT/logs/d25_c3_diag_floor_20260718"
...
C3_CORE=code/cvsrffi/stage2_multimodal_diag_floor_adapter.py
...
EXPECTED_RUNNER_SHA256=51f6a7ae52525f00a873f64cea357b2fb2a407fcbbca26cd8b9a02ca370fdbff
EXPECTED_C3_CORE_SHA256=0758174196e4277b01435b262dd30213c022b4edd38bc2238cb75d7963124bf7
...
verify_sha256 "$C3_CORE" "$EXPECTED_C3_CORE_SHA256"
