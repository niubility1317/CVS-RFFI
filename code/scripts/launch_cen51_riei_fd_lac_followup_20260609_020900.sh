...
RUN_ID="${RUN_ID:-cen51_riei_fd_lac_followup_20260609_020900}"
...
run_candidate CEN51_RIEIFD01_FS050_lac_primary CEN51_RIEIFD01_FS050_lac_primary_r010 50 0 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
...
run_candidate CEN51_RIEIFD02_FS005_sat_min_ablate CEN51_RIEIFD02_FS005_sat_min_ablate_r010 5 1 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
...
run_candidate CEN51_RIEIFD03_FS010_rx_floor_probe CEN51_RIEIFD03_FS010_rx_floor_probe_r010 10 2 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
...
run_candidate CEN51_RIEIFD04_FS100_r010_anchor_guard CEN51_RIEIFD04_FS100_r010_anchor_guard 100 3 \
  --test_eval_start_epoch \
  81 \
  --test_eval_interval \
  10 \
  ...
  0.78 \
  --sat_view_schedule \
  '1@0.65:clear_leo,mixed_orbit;130@0.90:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --use_sat_consistency \
  --lambda_sat_cons \
  0.004 \
  --sat_cons_start_epoch \
