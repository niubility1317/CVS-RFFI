...
# Centralized next8 after CEN_C17-C20/A21-A24 completed.
# Evidence anchors: CEN_C17 best clean/risk-adjusted, CEN_A22 best satellite/joint,
# CEN_C18/C20 satellite-floor collapse flags, and rx-chain remains a negative line.

ROOT="${ROOT:-/home/szu2070436088/2510044040/CV-SincNet}"
PYTHON="${PYTHON:-/home/szu2070436088/.conda/envs/CVS-RFFI/bin/python}"
RUN_ID="${RUN_ID:-optimizer_20260530_043050_centralized_next8}"
...
launch CEN_C25 \
  CEN_C25_c17_gce006_ce1p20_r010 \
  0 \
  "${MIXSTYLE_ARGS[@]}" \
...
launch CEN_C27 \
  CEN_C27_a22_cleanlowce_fishr005_r010 \
  2 \
  "${MIXSTYLE_ARGS[@]}" \
  --primary_udu_weight 0.70 \
...
launch CEN_C28 \
  CEN_C28_a22_protoonly_gdro_ce1p24_r010 \
  3 \
  "${MIXSTYLE_ARGS[@]}" \
  --primary_udu_weight 0.70 \
  --concat_sat_ce_weight 1.24 \
...
launch CEN_A29 \
  CEN_A29_a22_supcononly_gdro_ce1p24_r010 \
  4 \
  "${MIXSTYLE_ARGS[@]}" \
  --primary_udu_weight 0.70 \
  --concat_sat_ce_weight 1.24 \
  ...
  --groupdro_tau 0.50 \
  --groupdro_cap 0.65 \
  --lambda_supcon_id 0.035 \
  --supcon_temp 0.10 \
  --generalization_feature z_id
sleep 2

launch CEN_A30 \
  CEN_A30_a22_gce010_stack_ce1p24_r010 \
  5 \
  "${MIXSTYLE_ARGS[@]}" \
  --primary_udu_weight 0.70 \
  --concat_sat_ce_weight 1.24 \
...
launch CEN_A32 \
  CEN_A32_a22_nomix_stack_ce1p24_r010 \
  7 \
  --no_use_mixstyle \
  --primary_udu_weight 0.70 \
  --concat_sat_ce_weight 1.24 \
