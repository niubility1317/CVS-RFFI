#!/usr/bin/env python3
"""Write immutable strict-Pareto summaries for one complete D92-BE Hard12 run."""
...
from cvsrffi.stage2_d92_be_analysis import analyze_d92_be_hard12  # noqa: E402
...
def run(
    *,
    ...
    return {
        "status": "D92_BE_HARD12_STRICT_PARETO_ANALYSIS_COMPLETE",
