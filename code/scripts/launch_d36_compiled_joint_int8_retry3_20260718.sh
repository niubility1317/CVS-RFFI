...
OUTPUT="$RUN/output/support_screen_retry3"
LOG_ROOT="$PROJECT/logs/d36_compiled_joint_int8_20260718"
LOG="$LOG_ROOT/support_screen_retry3.log"
PID_FILE="$RUN/support_screen_retry3.pid"
PYCACHE_ROOT="$RUN/pycache_support_screen_retry3"
PYTHON=/home/szu2070436088/.conda/envs/SDG-SEI/bin/python
GPU="${D36_GPU:-0}"
...
PREDICTOR_BUNDLE=code/cvsrffi/stage2_predictor_bundle.py
EXPECTED_RUNNER_SHA256=aa879e5529075f43f30727f999dc0a23881e1adb64fecce39e0e4ade4d42550c
EXPECTED_D36_CORE_SHA256=e53b164b17da0ffcdf62b2f1024c931917d6d590fc5938b6f77a388270c3e09e
EXPECTED_D36_FISHER_SHA256=2cc05c0f2ef10c231698fdfd183ba84bcc1554a493e0d9bbbe318ac021f5d8ef
EXPECTED_PREDICTOR_BUNDLE_SHA256=0b17420162b3c9698e9e8c2fc5c5edcb374719d10c3bfcc9a8ffc20e00a63383
...
verify_sha256 "$PREDICTOR_BUNDLE" "$EXPECTED_PREDICTOR_BUNDLE_SHA256"
...
pid=$!
printf '%s\n' "$pid" >"$PID_FILE"
echo "D36_RETRY3_PID=$pid"
echo "D36_RETRY3_GPU=$GPU"
echo "D36_RETRY3_LOG=$LOG"
echo "D36_RETRY3_OUTPUT=$OUTPUT"
