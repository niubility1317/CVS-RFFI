...
OUTPUT="$RUN/output/support_screen_retry1"
LOG_ROOT="$PROJECT/logs/d36_compiled_joint_int8_20260718"
LOG="$LOG_ROOT/support_screen_retry1.log"
PID_FILE="$RUN/support_screen_retry1.pid"
PYCACHE_ROOT="$RUN/pycache_support_screen_retry1"
...
EXPECTED_D36_CORE_SHA256=32d8d5364c363513d9d9f54ed49575999df9a80bbc96edb06f3829ffc7f5198a
...
pid=$!
printf '%s\n' "$pid" >"$PID_FILE"
echo "D36_RETRY1_PID=$pid"
echo "D36_RETRY1_GPU=$GPU"
echo "D36_RETRY1_LOG=$LOG"
echo "D36_RETRY1_OUTPUT=$OUTPUT"
