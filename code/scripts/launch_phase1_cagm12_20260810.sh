...
COMMON=(
  ...
  --phase1_icmt_frozen_mode false --phase1_icmt_enabled false --lambda_icmt 0 --phase1_cp_sfce_frozen_mode false --phase1_cp_sfce_enabled false --lambda_cp_sfce 0
  --phase1_cagm_frozen_mode true --max_grad_norm 5.0 --checkpoint_selection final_only --best_metric clean_val_tx --phase1_source_val_selection_only true
...
launch_arm() {
  ...
  local -a arm_args
  case "${arm}" in
    C) arm_args=(--phase1_cagm_enabled false --lambda_cagm 0) ;;
    G) arm_args=(--phase1_cagm_enabled true --lambda_cagm 0.02) ;;
