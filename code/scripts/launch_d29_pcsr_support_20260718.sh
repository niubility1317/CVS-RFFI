...
RUN="$PROJECT/runs/d29_pcsr_20260718"
OUTPUT="$RUN/output/support_screen_v1"
LOG_ROOT="$PROJECT/logs/d29_pcsr_20260718"
...
EXPECTED_RUNNER_SHA256=9916f5087844aeb5567ed9eea3b4d5f6069abeb35fd59809afdb899fe409cba0
...
# Preserve the already verified remote operator; do not overwrite unrelated
# local in-progress diagnostic edits.
