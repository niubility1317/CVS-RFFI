...
RUN_ID="${RUN_ID:-cen51_lowshot_adapt_20260608_214000}"
...
run_candidate CEN51_LS01_FS005_clean_lite CEN51_LS01_FS005_clean_lite_r010 5 0 \
  --batch_size \
  128 \
  --epochs \
  170 \
  ...
  0.35 \
  --sat_view_schedule \
  1@0.35:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit \
  --lambda_sat_cons \
  0.0 \
...
run_candidate CEN51_LS02_FS005_delayed_sat CEN51_LS02_FS005_delayed_sat_r010 5 1 \
  --batch_size \
  128 \
  --epochs \
  190 \
  ...
  0.45 \
  --sat_view_schedule \
  '1@0.30:clear_leo,mixed_orbit;150@0.55:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.0015 \
  --sat_cons_start_epoch \
  160 \
...
run_candidate CEN51_LS03_FS010_clean_lite CEN51_LS03_FS010_clean_lite_r010 10 2 \
  --batch_size \
  128 \
  --epochs \
  175 \
  ...
  0.45 \
  --sat_view_schedule \
  1@0.45:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit \
  --lambda_sat_cons \
  0.0 \
  --sat_cons_start_epoch \
  999 \
...
run_candidate CEN51_LS04_FS010_delayed_sat CEN51_LS04_FS010_delayed_sat_r010 10 3 \
  --batch_size \
  128 \
  --epochs \
  190 \
  ...
  0.55 \
  --sat_view_schedule \
  '1@0.35:clear_leo,mixed_orbit;150@0.65:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.002 \
  --sat_cons_start_epoch \
  160 \
...
run_candidate CEN51_LS05_FS010_rx_floor CEN51_LS05_FS010_rx_floor_r010 10 4 \
  --batch_size \
  128 \
  --epochs \
  185 \
  ...
  0.4 \
  --sat_view_schedule \
  '1@0.35:clear_leo,mixed_orbit;145@0.50:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.0 \
  --sat_cons_start_epoch \
  999 \
...
run_candidate CEN51_LS06_FS020_clean_lite CEN51_LS06_FS020_clean_lite_r010 20 5 \
  --batch_size \
  256 \
  --epochs \
  200 \
  ...
  0.6 \
  --sat_view_schedule \
  '1@0.55:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit;150@0.65:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.0 \
  --sat_cons_start_epoch \
  999 \
...
run_candidate CEN51_LS07_FS020_delayed_sat CEN51_LS07_FS020_delayed_sat_r010 20 6 \
  --batch_size \
  256 \
  --epochs \
  200 \
  ...
  0.7 \
  --sat_view_schedule \
  '1@0.50:clear_leo,mixed_orbit;140@0.75:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.003 \
  --sat_cons_start_epoch \
  150 \
...
run_candidate CEN51_LS08_FS020_rx_floor CEN51_LS08_FS020_rx_floor_r010 20 7 \
  --batch_size \
  256 \
  --epochs \
  200 \
  ...
  0.6 \
  --sat_view_schedule \
  '1@0.50:clear_leo,mixed_orbit;145@0.65:clear_leo,low_elev_leo,rain_leo,storm_mp,mixed_orbit' \
  --lambda_sat_cons \
  0.0 \
  --sat_cons_start_epoch \
  999 \
