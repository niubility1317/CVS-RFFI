...
RUN="$PROJECT/runs/d30_envelope_int8_20260718"
OUTPUT="$RUN/output/support_screen_v1"
LOG_ROOT="$PROJECT/logs/d30_envelope_int8_20260718"
...
EXPECTED_RUNNER_SHA256=5bc4b2ebef4ec7a21b579ef9ddc890de3277d32e1e4069465ed7c2cf9867bc36
...
# Preserve the independently edited local diagnostic operator. D30 reuses the
