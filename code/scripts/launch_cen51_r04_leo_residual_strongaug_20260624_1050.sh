...
RUN_ID="${RUN_ID:-cen51_r04_leo_residual_strongaug_20260624_1050}"
RUN_NAME="${RUN_NAME:-CEN51_R04_LEO_RESIDUAL_STRONGAUG_R010}"
GPU_ID="${GPU_ID:-0}"
...
LEO_SCHEDULE="1@0.98:${LEO_SCENARIOS};115@0.82:${LEO_SCENARIOS}"
...
R04_STRONGAUG_ARGS=(
  ...
  --swad_start_epoch 70
  --swad_tolerance 0.34
  --sat_view_schedule "${LEO_SCHEDULE}"
)
...
echo "[CEN51-R04-LEO] run_id=${RUN_ID} run_name=${RUN_NAME} gpu=${GPU_ID} dry_run=${DRY_RUN}"
printf '[CEN51-R04-LEO-CMD]'
print_cmd "${CMD[@]}"
