...
echo "[PHASE1-ZIDBRIDGE] run_id=${RUN_ID} dry_run=${DRY_RUN} base=PHASE1_GPU0_JOINTSAFE36_SOFTPSEUDO_190X10_SHORT195_S3 candidates=7 mode=all_joint screen_epochs=${SCREEN_EPOCHS}/${SCREEN_LABEL_EPOCHS}+${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C0_CONSERVE_E${SCREEN_EPOCHS}" 1 360703 true 0.003 0.003 0.15 0.01 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C1_LOW_E${SCREEN_EPOCHS}" 2 360713 true 0.004 0.004 0.25 0.01 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C2_GEOM_E${SCREEN_EPOCHS}" 3 360723 true 0.004 0.006 0.25 0.02 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C3_PROTO_E${SCREEN_EPOCHS}" 4 360733 true 0.006 0.004 0.35 0.01 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C4_BALANCED_E${SCREEN_EPOCHS}" 5 360743 true 0.006 0.006 0.25 0.02 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C5_DOMAIN_E${SCREEN_EPOCHS}" 6 360753 true 0.004 0.005 0.50 0.03 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
launch_candidate "PHASE1_SHORT195S3_ZIDJOINT_C6_STRONG_E${SCREEN_EPOCHS}" 7 360763 true 0.008 0.006 0.35 0.03 "${SCREEN_EPOCHS}" "${SCREEN_LABEL_EPOCHS}" "${SCREEN_PSEUDO_EPOCHS}"
