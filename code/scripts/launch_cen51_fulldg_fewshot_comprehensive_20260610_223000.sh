...
RUN_ID="${RUN_ID:-cen51_fulldg_fewshot_comprehensive_20260610_223000}"
...
run_candidate FS005_BEST_HINGE6_SATMIN_1337 CEN51_FDCOMP_FS005_BEST_HINGE6_SATMIN_1337 5 0 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS005_BEST_HINGE6_SATMIN_2028 CEN51_FDCOMP_FS005_BEST_HINGE6_SATMIN_2028 5 1 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS005_BEST_HINGE6_SATMIN_2029 CEN51_FDCOMP_FS005_BEST_HINGE6_SATMIN_2029 5 2 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS005_BEST_HINGE6_SATMIN_2030 CEN51_FDCOMP_FS005_BEST_HINGE6_SATMIN_2030 5 3 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS010_BEST_IDFIRST_LATE_2028 CEN51_FDCOMP_FS010_BEST_IDFIRST_LATE_2028 10 4 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS010_BEST_IDFIRST_LATE_2029 CEN51_FDCOMP_FS010_BEST_IDFIRST_LATE_2029 10 5 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS010_BEST_IDFIRST_LATE_2030 CEN51_FDCOMP_FS010_BEST_IDFIRST_LATE_2030 10 6 \
  --batch_size \
  128 \
  --epochs \
  195 \
...
run_candidate FS020_BEST_RIEIFD_LIGHT_1337 CEN51_FDCOMP_FS020_BEST_RIEIFD_LIGHT_1337 20 7 \
  --batch_size \
  256 \
  --epochs \
  205 \
...
run_candidate FS020_BEST_RIEIFD_LIGHT_2028 CEN51_FDCOMP_FS020_BEST_RIEIFD_LIGHT_2028 20 0 \
  --batch_size \
  256 \
  --epochs \
  205 \
...
run_candidate FS020_BEST_RIEIFD_LIGHT_2029 CEN51_FDCOMP_FS020_BEST_RIEIFD_LIGHT_2029 20 1 \
  --batch_size \
  256 \
  --epochs \
  205 \
...
run_candidate FS030_BEST_RXFLOOR_CAP_2028 CEN51_FDCOMP_FS030_BEST_RXFLOOR_CAP_2028 30 2 \
  --batch_size \
  256 \
  --epochs \
  210 \
...
run_candidate FS030_BEST_RXFLOOR_CAP_2029 CEN51_FDCOMP_FS030_BEST_RXFLOOR_CAP_2029 30 3 \
  --batch_size \
  256 \
  --epochs \
  210 \
...
run_candidate FS030_BEST_RXFLOOR_CAP_2030 CEN51_FDCOMP_FS030_BEST_RXFLOOR_CAP_2030 30 4 \
  --batch_size \
  256 \
  --epochs \
  210 \
...
run_candidate FS050_BEST_CAP_RELAX_1337 CEN51_FDCOMP_FS050_BEST_CAP_RELAX_1337 50 5 \
  --batch_size \
  256 \
  --epochs \
  215 \
...
run_candidate FS050_BEST_CAP_RELAX_2028 CEN51_FDCOMP_FS050_BEST_CAP_RELAX_2028 50 6 \
  --batch_size \
  256 \
  --epochs \
  215 \
...
run_candidate FS050_BEST_CAP_RELAX_2029 CEN51_FDCOMP_FS050_BEST_CAP_RELAX_2029 50 7 \
  --batch_size \
  256 \
  --epochs \
  215 \
