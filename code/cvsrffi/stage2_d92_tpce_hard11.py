...
DEPLOYMENT_POLICY = {
    "revision": "pareto_safe_greedy_v2",
    "codec": "post_compile_direct_coef2_qint8_pair_exchange",
    "selection": "deterministic_pareto_safe_greedy_atomic_subset",
    "acceptance": "relative_to_e0_six_old_q20_pooled_new_cross_all_and_cross_hinges",
    "priority": "uncovered_required_tail_then_worst_gain_then_total_gain_then_semantic_handle",
