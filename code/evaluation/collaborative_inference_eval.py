...
def build_model_from_checkpoint_args(context, overrides: argparse.Namespace, device: torch.device):
    ...
    model = build_dual_model(
        ...
        use_ntrs=bool(_get_arg(args, "use_ntrs", False)),
        ntrs_rank=int(_get_arg(args, "ntrs_rank", 8)),
        ntrs_alpha_max=float(_get_arg(args, "ntrs_alpha_max", 0.20)),
        ntrs_q_dim=int(_get_arg(args, "ntrs_q_dim", 32)),
        ntrs_fast_dim=int(_get_arg(args, "ntrs_fast_dim", 24)),
        ntrs_slow_dim=int(_get_arg(args, "ntrs_slow_dim", 24)),
        ntrs_metadata_dim=int(_get_arg(args, "ntrs_metadata_dim", 9)),
        ntrs_slow_ema_decay=float(_get_arg(args, "ntrs_slow_ema_decay", 0.95)),
        ...
        ntrs_q_trainable=bool(_get_arg(args, "ntrs_q_trainable", True)),
        ntrs_use_support_gate=bool(_get_arg(args, "ntrs_use_support_gate", False)),
        ntrs_context_mode=str(_get_arg(args, "ntrs_context_mode", "normalized")),
        ntrs_operator_mode=str(_get_arg(args, "ntrs_operator_mode", "operator")),
        ntrs_pca_artifact=str(_get_arg(args, "ntrs_pca_artifact", "")),
