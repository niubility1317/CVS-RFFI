...
class Phase2SupportMetricQknnV55PolicyTest(unittest.TestCase):
    def test_v55_adds_low_k_query_cluster_and_reuses_high_k_v49_guard(self):
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v55")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v55")
        self.assertEqual(low_k["adaptive_qknn_effective_policy"], "stable_dualview_v55")
        ...
        self.assertGreater(low_k["query_cluster_weight"], 0.0)
        self.assertEqual(low_k["query_cluster_scope"], "new")

        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v55")
