...
class Phase2SupportMetricQknnV53PolicyTest(unittest.TestCase):
    def test_v53_uses_low_k_registration_and_high_k_v49_guard(self):
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v53")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v36")
        self.assertEqual(low_k["adaptive_qknn_effective_policy"], "stable_dualview_v36")
        ...
        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v53")
