...
class Phase2SupportMetricQknnV56CompressionTest(unittest.TestCase):
    ...
    def test_v79_applies_lighter_labelprop_on_v78_high_compression_branch_only_for_k10(self):
        from phase2_support_metric_qknn_probe import _adaptive_qknn_overrides
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v79")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v79")
        self.assertNotIn("support_code_old_budget_per_class", low_k)
        self.assertNotIn("support_code_new_protect_top_classes", low_k)
        self.assertNotIn("labelprop_weight", low_k)
        self.assertNotIn("scenario_residual_weight", low_k)

        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v79")
        self.assertEqual(high_k["adaptive_qknn_policy"], "stable_dualview_v79")
        self.assertEqual(high_k["support_code_budget_per_class"], 0)
        self.assertEqual(high_k["support_code_budget_mode"], "centroid_hard_diverse")
        self.assertEqual(high_k["support_code_old_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_budget_per_class"], 6)
    ...
    def test_v81_adds_small_risk_extra_budget_on_v79_branch_only_for_k10(self):
        from phase2_support_metric_qknn_probe import _adaptive_qknn_overrides
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v81")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v81")
        self.assertNotIn("support_code_old_budget_per_class", low_k)
        self.assertNotIn("support_code_new_protect_top_classes", low_k)
        ...
        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v81")
        self.assertEqual(high_k["adaptive_qknn_policy"], "stable_dualview_v81")
        self.assertEqual(high_k["support_code_budget_per_class"], 0)
        self.assertEqual(high_k["support_code_budget_mode"], "centroid_hard_diverse")
        self.assertEqual(high_k["support_code_old_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_budget_per_class"], 6)
    ...
    def test_v87_keeps_v86_compression_and_uses_floor_stable_aux_weight_for_k10_only(self):
        from phase2_support_metric_qknn_probe import _adaptive_qknn_overrides
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v87")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v87")
        self.assertNotIn("support_code_new_extra_budget_top_classes", low_k)
        self.assertNotIn("aux_score_weight", low_k)
        self.assertNotIn("old_bias", low_k)

        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v87")
        self.assertEqual(high_k["adaptive_qknn_policy"], "stable_dualview_v87")
        self.assertEqual(high_k["support_code_old_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_budget_per_class"], 6)
        self.assertEqual(high_k["support_code_new_protect_top_classes"], 12)
        self.assertEqual(high_k["support_code_new_extra_budget_top_classes"], 14)
        self.assertEqual(high_k["support_code_new_extra_budget_per_class"], 8)
        self.assertEqual(high_k["aux_score_weight"], 0.58)
        self.assertEqual(high_k["old_bias"], 0.002)
        self.assertEqual(high_k["labelprop_weight"], 0.01)
        self.assertEqual(high_k["scenario_residual_weight"], 0.5)
        self.assertNotIn("neighbor_contrast_count", high_k)

    def test_v88_compresses_v87_to_180_codes_for_k10_only(self):
        from phase2_support_metric_qknn_probe import _adaptive_qknn_overrides
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v88")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v88")
        self.assertNotIn("support_code_new_extra_budget_top_classes", low_k)
        self.assertNotIn("aux_score_weight", low_k)
        self.assertNotIn("old_bias", low_k)

        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v88")
        self.assertEqual(high_k["adaptive_qknn_policy"], "stable_dualview_v88")
        self.assertEqual(high_k["support_code_old_budget_per_class"], 5)
    ...
    def test_v89_adds_k5_light_residual_and_keeps_v88_k10_compression(self):
        from phase2_support_metric_qknn_probe import _adaptive_qknn_overrides
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v89")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v89")
        self.assertNotIn("support_code_old_budget_per_class", low_k)
        self.assertNotIn("support_code_new_budget_per_class", low_k)
        self.assertNotIn("support_code_new_extra_budget_top_classes", low_k)
        self.assertEqual(low_k["aux_score_weight"], 0.64)
        self.assertEqual(low_k["labelprop_weight"], 0.0)
        self.assertEqual(low_k["local_competition_weight"], 0.02)
        self.assertEqual(low_k["local_competition_k"], 5)
        self.assertEqual(low_k["local_competition_clip"], 2.0)
        self.assertEqual(low_k["local_competition_scope"], "role")
        self.assertEqual(low_k["scenario_residual_weight"], 0.25)
        self.assertEqual(low_k["scenario_residual_min_classes"], 2)
        self.assertEqual(low_k["scenario_residual_clip"], 0.5)
        self.assertEqual(low_k["scenario_residual_scope"], "new")
        self.assertNotIn("neighbor_contrast_count", low_k)

        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v89")
        self.assertEqual(high_k["adaptive_qknn_policy"], "stable_dualview_v89")
        self.assertEqual(high_k["support_code_old_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_protect_top_classes"], 10)
        self.assertEqual(high_k["support_code_new_protect_metric"], "radius_proto_sim")
    ...
    def test_v90_tightens_k5_residual_and_keeps_v88_k10_compression(self):
        from phase2_support_metric_qknn_probe import _adaptive_qknn_overrides
        ...
        self.assertEqual(low_k["adaptive_qknn_requested_policy"], "stable_dualview_v90")
        self.assertEqual(low_k["adaptive_qknn_policy"], "stable_dualview_v90")
        self.assertNotIn("support_code_old_budget_per_class", low_k)
        self.assertNotIn("support_code_new_budget_per_class", low_k)
        self.assertNotIn("support_code_new_extra_budget_top_classes", low_k)
        ...
        self.assertEqual(high_k["adaptive_qknn_requested_policy"], "stable_dualview_v90")
        self.assertEqual(high_k["adaptive_qknn_policy"], "stable_dualview_v90")
        self.assertEqual(high_k["support_code_old_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_budget_per_class"], 5)
        self.assertEqual(high_k["support_code_new_protect_top_classes"], 10)
        self.assertEqual(high_k["support_code_new_protect_metric"], "radius_proto_sim")
