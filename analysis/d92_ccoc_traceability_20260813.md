...
|CCOC-04|rho为全部类pairwise Frobenius cosine均值并clip到`[0,1]`|CCOC core|手算fixture、负相关/一致端点|待实现|
...
|CCOC-13|部署state非E0，至少一个rho严格内部，跨组margin变化≥真实D42量子|query receipt/G0 validator|真实K10三场景truth-free G0|待运行|
