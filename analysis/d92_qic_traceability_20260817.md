...
|QIC-04|G0 decision|Truth-free three-scene G0 launcher and receipt validator|G0 release files|LOCAL_VERIFIED|bash-n、archive边界、extract/import、JSON、外部镜像复核|仅封包；未运行N607、无scorer|
