...
|QIC-04|G0 decision|Truth-free three-scene G0 launcher and receipt validator|G0 release files|v1_TECHNICAL_STOP;v2_LOCAL_VERIFIED|v1证实driver重定向自引用失败；v2定向RED→GREEN、runner 8项、bash-n和archive边界通过|v1无方法/资源/性能结果；v2只删除脚本内out/err自引用fresh检查|
|QIC-05|Hard9+K1 decision|9 performance+1 K1、30 scene-arm、8-shard truth-last screen|QIC Hard9 matrix/runner/analyzer/release|LOCAL_VERIFIED|联合45项、py_compile、CLI help、JSON、bash-n、50-member archive/source manifest、外部镜像通过|等待sole runner；无Hard9性能结果|
