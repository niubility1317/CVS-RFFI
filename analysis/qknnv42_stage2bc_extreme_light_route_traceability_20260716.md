...
|R05|真实嵌套5/10/20 seen-new TX覆盖|max20_cache_plan_locked_data_missing|new20合法顺序固定，new5/new10为同一authority/cache的嵌套前缀；30个maxK20+Q20 spec已锁定，但除既有20-1/713101开发cache外尚未构建|
