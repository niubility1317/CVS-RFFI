...
后续truth-free七receiver复核共7fit/2800step、21行，三个K均7/7 ACTIVE；K10在`1-1`和`2-1`分别出现2和1次INT8/FP32 teacher-winner翻转，当前正式门必拒绝。在两条已观察失败行内，分量诊断把3次翻转定位到单尺度支持向量INT8方向编码，FP16类带宽不是根因。D104部署同构support-only角度网格完成8400行0重构退化性质审计，并在两行达到100%一致、0翻转；但它属于冻结后新机制，只能进入新candidate重入，禁止原地改R2。当前无BA/floor/H/Target结果，旧N607命令撤销。
