...
|D48-11|真实105行协议、source、ground、state、resource、artifact与30条fit audit全部通过|probe|pending|首次底层105行完成但6条low-elev audit因固定2e-7未覆盖合法FP32舍入而后验fail closed；失败artifact保留，修复ULP verifier后须新目录重跑|
