...
改派结果VERIFIED：控制脚本提交060cd29075062d8edbc32cb92956690a48660055已push并独立核对OID；单文件发布在releases/a1_queue_060cd290，SHA256=1e6034d6dbbfcf6225e38f9013ad7c9e7a39432d376994f65e25c127695f9a60，两端一致且远端编译PASS。新dispatcher907248存活，原dispatcher839257已退出，X2原训练PID839936/839941仍活动并由PID1托管。新R3 PID907259、PPID907248，CUDA_VISIBLE_DEVICES=7，仍从零训练E400，E200起每20轮测试。pipeline三行RUNNING、waiting_rows为空。GPU7为F0+R3两个训练进程；没有停止或重新启动X2。

核验额外发现GPU3已有第三个计算进程852891，来自另一独立LoRa v7任务（releases/tweak_config2_portability_20260910_v7/source），不是本次GPU7改派产生。不得把本次结果描述为“全机每卡最多两个已满足”；仅GPU7本次容量核对通过。保留其他任务并报告该外部占位，不擅自停止或移动它。详细argv、初始化和GPU证据见analysis/a1_r3_gpu7_startup.json。
