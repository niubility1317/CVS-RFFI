...
截至2026-09-10北京时间22:20的完整主快照；X2_E600曲线补读至E184。范围为本对话13个A1相关run根目录、58条实验/历史/占位记录。完整解析6884条epoch记录并扫描310961行训练stdout，JSONL与CSV行数一致、未见解析或列宽错误。58条不等于58个完成实验，活动run也不是全服务器任务清单。
...
|---|---:|---:|---:|---:|
|X0_A1_RUNTIME|78.4696|68.1246|+0.0000|-0.0827|
|X1_CROSS_RX_CLEAN|79.1327|68.5167|+0.3921|+0.3093|
|X2_CROSS_RX_VIEWS|78.4202|68.2073|+0.0827|+0.0000|
|X3_WARM_EMA|78.7339|68.3692|+0.2446|+0.1619|
|X4_COVERAGE_KL|78.4298|67.8540|-0.2706|-0.3534|
|X5_BALANCED_L|78.2500|64.5153|-3.6093|-3.6921|
|X6_BOUNDED_DOMAIN|78.7315|67.0956|-1.0290|-1.1117|
|X7_COMBINED|75.9976|64.0986|-4.0260|-4.1087|
...
本矩阵设计文档的EX7明确为deferred：物理估计、复杂锚点和固定融合本轮不实现。因此正确名称是“A1+ECRS跨RX身份约束”。[设计依据](E:/type10-7/code/snapshots/a1_fast_v2_20260909_wt/docs/A1_ECRS_CROSS_RX_ADAPTATION_20260909.md)
...
R3代码在[objective第71行](E:/type10-7/code/snapshots/a1_fast_v2_20260909_wt/code/cvsrffi/a1_r3_objective.py)创建零η、全false有效掩码，第85行传入空重编码；模块开头已说明η元数据不可用。这是有记录的范围裁剪，当前证据不支持把它称为新发现的静默开关故障。若设计声明要求完整FCR，则这些就是实质实现缺口。独立响应估计器的固定/无梯度求解与后端响应编码器可训练是不同层，不应混为“响应完全没有训练”。
...
新增完成的F0_R3_REFERENCE target LEO均值为66.905754%，F3_R3_SWAP为67.089683%，匹配差值只有+0.183929pp。即使F3相对B0或别的行改善，也不能把跨骨架差异全归因于swap。F0/F3这组才更接近对应机制比较。
...
- [只读采集脚本](E:/type10-7/code/snapshots/a1_fast_v2_20260909_wt/analysis/audit_conversation_mechanisms.py)、[完整曲线采集](E:/type10-7/code/snapshots/a1_fast_v2_20260909_wt/analysis/inspect_extended_signal.py)、[本报告计算与构建](E:/type10-7/code/snapshots/a1_fast_v2_20260909_wt/analysis/build_mechanism_activation_report.py)。
