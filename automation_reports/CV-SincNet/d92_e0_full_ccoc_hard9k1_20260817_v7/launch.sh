...
source_root="$project/runs/d92_ccoc_hard9_k1_source_386c659d_20260817_v7"
runtime_archive="$project/runs/d92_ccoc_hard9_k1_source_386c659d_20260817_v7.tar.gz"
driver="$project/runs/d92_ccoc_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_ccoc_hard9_k1_20260817_v7"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_ccoc_hard9_k1_v7.json"
runner="$code_root/scripts/run_d92_ccoc_hard9_k1.py"
source_manifest="$code_root/D92_CCOC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=17abc626c49d669f12aceaa9e2cdf3deaa766eef1f5d06b700d66db59d500a3d
archive_size_bytes=310047
