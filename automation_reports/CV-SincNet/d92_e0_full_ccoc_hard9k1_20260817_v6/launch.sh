...
source_root="$project/runs/d92_ccoc_hard9_k1_source_9c22dc42_20260817_v6"
runtime_archive="$project/runs/d92_ccoc_hard9_k1_source_9c22dc42_20260817_v6.tar.gz"
driver="$project/runs/d92_ccoc_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_ccoc_hard9_k1_20260817_v6"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_ccoc_hard9_k1_v6.json"
runner="$code_root/scripts/run_d92_ccoc_hard9_k1.py"
source_manifest="$code_root/D92_CCOC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=f815686e92c4b5e00c79e28795713f22d85edd0accb6584610750fd863e76fd1
archive_size_bytes=308770
