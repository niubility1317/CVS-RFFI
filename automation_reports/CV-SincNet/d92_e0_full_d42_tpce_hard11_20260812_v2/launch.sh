...
source_root="$project/runs/d92_tpce_source_snapshot_4768c6b2_20260812_v2"
code_root="$source_root/code"
runtime_archive="$source_root/d92_tpce_runtime_closure_4768c6b2.tar.gz"
...
output="$project/runs/d92_e0_full_d42_tpce_hard11_20260812_v2"
logs="$project/logs/d92_e0_full_d42_tpce_hard11_20260812_v2"

require_file() { test -f "$1" || { printf 'required file missing: %s\n' "$1" >&2; exit 64; }; }
require_file "$runtime_archive"
test "$(sha256sum "$runtime_archive" | awk '{print $1}')" = "e775b66584a83756e11834dfcf2908398c9707b783e2c1fe71628f6944f388a7"
