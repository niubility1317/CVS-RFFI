...
source_root="$project/runs/d92_e0ocf_source_snapshot_20260811_v3"
code_root="$source_root/code"
runtime_archive="$source_root/d92_e0ocf_runtime_closure_e5e498fb.tar.gz"
...
output="$project/runs/d92_e0ocf_5arm_hard12v3_20260811_v3"
logs="$project/logs/d92_e0ocf_5arm_hard12v3_20260811_v3"
...
test "$(sha256sum "$runtime_archive" | awk '{print $1}')" = \
  "e5e498fb6023415f778d43e176a9e41e998f9aa20688c596f3a26967fc74841a"
