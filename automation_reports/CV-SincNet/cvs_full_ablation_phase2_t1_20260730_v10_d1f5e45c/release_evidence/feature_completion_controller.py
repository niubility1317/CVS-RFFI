"""Build the 99 missing Stage2 feature-cache triples for the fresh v10 output."""
...
def _feature_root(
    output_root: Path, receiver: str, method_seed: int, k_shot: int
) -> Path:
    return (
        output_root
        / "artifacts"
...
def _subprocess_environment(
    ...
    *,
    ...
    release_code = str(release_root / "code")
...
def _build_command(
    ...
    *,
    ...
    return [
        ...
        "--cache-output-root",
        str(_feature_root(args.output_root, receiver, method_seed, k_shot)),
        "--phase2-data-status",
        "VALIDATED_ONCE",
        "--capsule-id",
        (
...
def main() -> int:
    ...
    if args.output_root.exists():
        raise FileExistsError("fresh output root must be absent")
    ...
    summary = {
        "schema": "cvs.stage2.v10.feature_completion.v1",
    ...
    output = args.output_root / "source" / "feature_completion_summary.json"
