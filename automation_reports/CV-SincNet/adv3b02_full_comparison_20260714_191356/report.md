...
|生成时间|2026-07-14T19:21:29+08:00|
|操作者|Codex|
...
严格可引用的轻量路径是`qKNNV42+单视图FFT96`：old_acc=75.12%、new_acc=64.64%、H=68.56%。完整体为old_acc=84.07%、new_acc=93.24%、H=88.23%，但其同时使用60epoch特征适配、5-view TTA和Oracle角色/类别配额，必须标记`NON_DEPLOYMENT_ORACLE_DIAGNOSTIC`。
...
|完整qKNN legacy Oracle|84.07%|93.24%|88.23%|125|严格加载0/0/0；但含Oracle约束|NON_DEPLOYMENT_ORACLE_DIAGNOSTIC|
...
- 严格完整体相对严格单视图FFT96提高old 8.94pp、new 28.60pp、H 19.66pp；该差值混合adapter、TTA与Oracle。
...
|完整qKNN legacy Oracle|81.10%|86.23%|89.59%|91.40%|92.81%|
