...
run_id=d92_e0_full_d42_qic_hard9k1_20260817_v1
fresh_run_retry=false
source_root="$project/runs/d92_qic_hard9_k1_source_d4a986b6_20260817_v1"
runtime_archive="$project/runs/d92_qic_hard9_k1_source_d4a986b6_20260817_v1.tar.gz"
driver="$project/runs/d92_qic_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_qic_hard9_k1_20260817_v1"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_qic_hard9_k1_v1.json"
runner="$code_root/scripts/run_d92_qic_hard9_k1.py"
source_manifest="$code_root/D92_QIC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=22c91aeb648c76117e002accea09ffb55c96f3a5cb80d0863236b13128104fa2
archive_size_bytes=320148
