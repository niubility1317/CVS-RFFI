...
- 本地已回收29件可验证远端artifact（F1C/F1G/F2C/F2G/F3C/F3G/F4C各3件，F5C各3件，F5G仅JSON+CSV），并生成`retrieval_partial_manifest.json`记录缺失清单；artifact根：`E:\type10-7\automation_reports\CV-SincNet\phase1_cp_sfce_postfreeze_20260809_v1\artifacts`。bridge在续传F5G日志及F6C/F6G、pair、pids/outer时Connection reset/refused；本地SSH/SCP/TCP22已清理，未重启或重跑。后续仅允许retrieval-only续传并补齐manifest/completion。
