...
- 计划新增：`code/scripts/probe_d49_nested_global_cosine_fusion.py`、`tests/test_probe_d49_nested_global_cosine_fusion.py`、`analysis/d49_nested_global_cosine_fusion_traceability_20260719.md`。
