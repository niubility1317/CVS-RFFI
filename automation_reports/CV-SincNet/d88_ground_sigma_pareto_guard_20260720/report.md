...
- 单一主要差异：相对D87只增加逐类、角色无关的common-descent cone projection与exact per-class line-search guard；地面v2组件、14个方向、半径幅度、sigma权重、20步、rank13空间、D78 trust ball、D79中心化仿射编译全部不变。
