...
|status|completed_exported_stage2c_base_negative|
...
|2026-07-06 06:24|`EPOC_R7_FLOOR_LOCKED_SHELL`|183/200|10|85.7313|98.6369|90.6623|98.5536|94.6514|1|0.4793|0.8171|0.8339|not yet|running; prototype absent, proxy still below random|
|2026-07-06 06:24|`EPOC_R7_BALANCED_LOW_DENSITY`|182/200|90|85.8023|98.6012|90.0270|98.6250|93.8822|1|0.4399|0.8093|0.7709|not yet|running; E182 test_tx=89.5270 below best, prototype absent|
|2026-07-06 06:27|`EPOC_R7_FLOOR_LOCKED_SHELL`|185/200|10|85.7313|98.6369|90.6623|98.6131|93.7861|1|0.4758|0.8202|0.8328|not yet|running; prototype absent, proxy still below random|
|2026-07-06 06:27|`EPOC_R7_BALANCED_LOW_DENSITY`|184/200|90|85.8023|98.6012|90.0270|98.6250|94.3029|1|0.4349|0.8115|0.7542|not yet|running; E184 test_tx=89.7373 below best, prototype absent|
|2026-07-06 06:31|`EPOC_R7_FLOOR_LOCKED_SHELL`|187/200|10|85.7313|98.6369|90.6623|98.5893|92.7284|1|0.4829|0.8195|0.8473|not yet|running; prototype absent, proxy still below random|
|2026-07-06 06:31|`EPOC_R7_BALANCED_LOW_DENSITY`|187/200|90|85.8023|98.6012|90.0270|98.6071|93.3654|1|0.4380|0.8051|0.7691|not yet|running; prototype absent, proxy still negative|
|2026-07-06 06:34|`EPOC_R7_FLOOR_LOCKED_SHELL`|189/200|10|85.7313|98.6369|90.6623|98.6250|93.1250|1|0.4739|0.8183|0.8442|not yet|running; prototype absent, proxy still below random|
|2026-07-06 06:34|`EPOC_R7_BALANCED_LOW_DENSITY`|189/200|90|85.8023|98.6012|90.0270|98.6369|93.8702|1|0.4410|0.8099|0.7744|not yet|running; prototype absent, proxy still negative|
|2026-07-06 06:40|`EPOC_R7_FLOOR_LOCKED_SHELL`|192/200|190|85.8987|98.6012|90.2147|98.6190|93.2813|1|0.4793|0.8192|0.8381|not yet|running; E190 refreshed best_test_tx, prototype absent, proxy still below random|
|2026-07-06 06:40|`EPOC_R7_BALANCED_LOW_DENSITY`|192/200|90|85.8023|98.6012|90.0270|98.5893|94.6274|1|0.4415|0.8122|0.7643|not yet|running; prototype absent, proxy still negative|
|2026-07-06 07:06|`EPOC_R7_FLOOR_LOCKED_SHELL`|200/200|194|86.0011|98.6071|90.1167|98.5952|92.2596|1|0.4793|0.8175|0.8439|exported|completed; Stage2-C base qknn8 failed|
|2026-07-06 07:06|`EPOC_R7_BALANCED_LOW_DENSITY`|200/200|90|85.8023|98.6012|90.0270|98.6250|94.3630|1|0.4374|0.8063|0.7515|exported|completed; Stage2-C base qknn8 failed|
...
06:24 CST只读监控结论：N607预检PASS，GPU2/3分别约2669/2665MiB，GPU0/1/4/5/6/7仍约10MiB；R7两个主PID仍运行。短命令检查时日志尾部显示`FLOOR_LOCKED_SHELL`到E182/200、`BALANCED_LOW_DENSITY`到E181/200；随后只读拉取`metrics_epoch.csv`时已推进到`FLOOR_LOCKED_SHELL` E183/200、`BALANCED_LOW_DENSITY` E182/200。`find`仍未发现`phase2_zid_prototypes.pt`或Stage2 feature npz，错误扫描未见Traceback、RuntimeError、CUDA OOM、out-of-memory、unrecognized arguments或Killed。`FLOOR_LOCKED_SHELL`best仍为E010，E183 proxy AUC为0.4793、virtual accept为0.8171、source episode overflow为0.8339；`BALANCED_LOW_DENSITY`best仍为E090，E182 test_tx为89.5270，低于best_test_tx 90.0270，proxy AUC为0.4399、virtual accept为0.8093、soft unknown mixup virtual accept为0.9949、source episode overflow为0.7709。当前仍不能启动R7 Stage2-C qknn8协同推理全量复评；R7过程证据继续显示未知proxy分离不足。SSH/SCP后均复查为`NO_SSH_PROCESS`、`NO_N607_OR_BRIDGE_ESTABLISHED_22`。

06:27 CST只读监控结论：N607预检PASS，GPU2/3分别约2669/2665MiB，GPU0/1/4/5/6/7仍约10MiB；R7两个主PID仍运行。短命令检查时日志尾部显示`FLOOR_LOCKED_SHELL`到E184/200、`BALANCED_LOW_DENSITY`到E183/200；随后只读拉取`metrics_epoch.csv`时已推进到`FLOOR_LOCKED_SHELL` E185/200、`BALANCED_LOW_DENSITY` E184/200。`find`仍未发现`phase2_zid_prototypes.pt`或Stage2 feature npz，错误扫描未见Traceback、RuntimeError、CUDA OOM、out-of-memory、unrecognized arguments或Killed。`FLOOR_LOCKED_SHELL`best仍为E010，E185 proxy AUC为0.4758、virtual accept为0.8202、source episode overflow为0.8328；`BALANCED_LOW_DENSITY`best仍为E090，E184 test_tx为89.7373，低于best_test_tx 90.0270，proxy AUC为0.4349、virtual accept为0.8115、soft unknown mixup virtual accept为1.0000、source episode overflow为0.7542。当前仍不能启动R7 Stage2-C qknn8协同推理全量复评；R7过程证据继续显示未知proxy分离不足。SSH/SCP后均复查为`NO_SSH_PROCESS`、`NO_N607_OR_BRIDGE_ESTABLISHED_22`。

06:31 CST只读监控结论：N607预检PASS，GPU2/3分别约2669/2665MiB，GPU0/1/4/5/6/7仍约10MiB；R7两个主PID仍运行。短命令检查时日志尾部显示`FLOOR_LOCKED_SHELL`到E187/200、`BALANCED_LOW_DENSITY`到E186/200；随后只读拉取`metrics_epoch.csv`时两个分支均为E187/200。`find`仍未发现`phase2_zid_prototypes.pt`或Stage2 feature npz，错误扫描未见Traceback、RuntimeError、CUDA OOM、out-of-memory、unrecognized arguments或Killed。`FLOOR_LOCKED_SHELL`best仍为E010，E187 proxy AUC为0.4829、virtual accept为0.8195、source episode overflow为0.8473；`BALANCED_LOW_DENSITY`best仍为E090，E187 proxy AUC为0.4380、virtual accept为0.8051、soft unknown mixup virtual accept为0.9974、source episode overflow为0.7691。当前仍不能启动R7 Stage2-C qknn8协同推理全量复评；R7过程证据继续显示未知proxy分离不足。SSH/SCP后均复查为`NO_SSH_PROCESS`、`NO_N607_OR_BRIDGE_ESTABLISHED_22`。

06:34 CST只读监控结论：N607预检PASS，GPU2/3分别约2669/2665MiB，GPU0/1/4/5/6/7仍约10MiB；R7两个主PID仍运行且均到E189/200。`find`仍未发现`phase2_zid_prototypes.pt`或Stage2 feature npz，错误扫描未见Traceback、RuntimeError、CUDA OOM、out-of-memory、unrecognized arguments或Killed。`FLOOR_LOCKED_SHELL`best仍为E010，E189 proxy AUC为0.4739、virtual accept为0.8183、source episode overflow为0.8442；`BALANCED_LOW_DENSITY`best仍为E090，E189 proxy AUC为0.4410、virtual accept为0.8099、soft unknown mixup virtual accept为0.9981、source episode overflow为0.7744。当前仍不能启动R7 Stage2-C qknn8协同推理全量复评；R7过程证据继续显示未知proxy分离不足。SSH/SCP后均复查为`NO_SSH_PROCESS`、`NO_N607_OR_BRIDGE_ESTABLISHED_22`。

06:40 CST只读监控结论：N607预检PASS，GPU2/3分别约2797/2665MiB，GPU0/1/4/5/6/7仍约10MiB；R7两个主PID仍运行，`FLOOR_LOCKED_SHELL`到E192/200，`BALANCED_LOW_DENSITY`到E192/200。`find`仍未发现`phase2_zid_prototypes.pt`或Stage2 feature npz，错误扫描未见Traceback、RuntimeError、CUDA OOM、out-of-memory、unrecognized arguments或Killed。只读拉取两个`metrics_epoch.csv`到本地临时目录`E:\type10-7\local_artifacts\r7_metrics_20260706_0640`解析。`FLOOR_LOCKED_SHELL`在E190刷新best_score到85.8987、best_test_tx到90.2147，但E192最新test_tx为89.3887；E192 proxy AUC为0.4793、virtual accept为0.8192、source episode overflow为0.8381。`BALANCED_LOW_DENSITY`best仍为E090，E192 proxy AUC为0.4415、virtual accept为0.8122、soft unknown mixup virtual accept为0.9974、source episode overflow为0.7643。当前仍不能启动R7 Stage2-C qknn8协同推理全量复评；FLOOR旧类测试best略有改善，但未知proxy分离仍未形成。SSH/SCP后均复查为`NO_SSH_PROCESS`、`NO_N607_OR_BRIDGE_ESTABLISHED_22`。

07:06 CST收尾结论：两个R7候选均完成E200/200并导出`phase2_zid_prototypes.pt/json`。`FLOOR_LOCKED_SHELL`最终best_epoch=194、best_score=86.0011、best_test_tx=90.1167，E200 proxy AUC=0.4793、virtual accept=0.8175，sat_mean=76.79%、sat_floor=75.99%、strict_udu=83.60%、receiver_floor=68.52%；`BALANCED_LOW_DENSITY`最终best_epoch=90、best_score=85.8023、best_test_tx=90.0270，E200 proxy AUC=0.4374、virtual accept=0.8063、soft unknown mixup virtual accept=0.9994，sat_mean=78.86%、sat_floor=77.89%、strict_udu=85.84%、receiver_floor=73.60%。随后用`phase2_r7_qknn8_collab_20260706`执行Stage2-C基础qknn8协同复评，两个case的`stage2_success_claim=false`。最佳M=1也只有FLOOR old=14.77%、seen_new=0%、unknown_reject=35.38%；BALANCED old=21.53%、seen_new=0%、unknown_reject=38.28%。M=5时分别降至FLOOR old=14.20%、unknown_reject=19.74%和BALANCED old=19.83%、unknown_reject=21.61%。因此R7确认进入负证据：旧类/新类/未知拒识均未接近目标，下一步应改变地面模型表征学习或蒸馏结构，而不是继续微调基础qknn8协同阈值。
...
06:41 CST执行本地到N607同步：`report.md`同步到`/home/szu2070436088/2510044040/CV-SincNet/automation_reports/CV-SincNet/phase1_epoc_r7_floor_protected_shell_20260706/report.md`，`code/SYNC_MANIFEST.txt`同步到`/home/szu2070436088/2510044040/CV-SincNet/code/SYNC_MANIFEST.txt`，并用本地`Get-FileHash`和远端`sha256sum`核对一致。同步后复查为`NO_SSH_PROCESS`、`NO_N607_OR_BRIDGE_ESTABLISHED_22`。本次只记录E192/E192监控状态；Stage2-C qknn8协同复评仍等待prototype导出。
