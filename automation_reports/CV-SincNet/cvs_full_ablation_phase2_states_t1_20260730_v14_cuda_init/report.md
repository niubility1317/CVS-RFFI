...
|状态|`ANALYZED / STATES_MATRIX_COMPLETE`|
...
325/325行均成功闭合。下表保留同一arm内的联合指标；数值为75个Stage2-B行的`均值±标准差/中位数[bootstrap 95% CI]`，S2A为25个Stage2-A行。

|状态/arm|old注册前准确率|old最差类准确率|相对FULL的old注册前变化|相对FULL的old最差类变化|
|---|---:|---:|---:|---:|
|S2A|0.6084±0.1138/0.6333[0.5136,0.7024]|0.2307±0.1241/0.2000[0.1487,0.3220]|不适用|不适用|
|PROTO|0.6920±0.1215/0.7167[0.6117,0.7607]|0.3480±0.2070/0.3500[0.2380,0.4495]|−0.0338[−0.0508,−0.0158]|−0.0517[−0.0772,−0.0255]|
|DIAGOFF|0.7204±0.1357/0.7333[0.6470,0.7831]|0.3908±0.2349/0.4000[0.2903,0.4960]|−0.0054[−0.0088,−0.0018]|−0.0088[−0.0197,0.0013]|
|FULL|0.7258±0.1351/0.7417[0.6511,0.7907]|0.3997±0.2374/0.4000[0.2927,0.5092]|0|0|

### K-shot效应

|K|S2A old注册前|FULL old注册前|FULL−S2A|FULL old最差类|
|---:|---:|---:|---:|---:|
|1|0.6084|0.6079|−0.0006|0.2147|
|2|0.6084|0.6796|+0.0711|0.3120|
|5|0.6084|0.7772|+0.1688|0.4720|
|10|0.6084|0.8384|+0.2300|0.6000|

## 结论

- Stage2状态更新的收益随K单调增大；K=1时没有可辨认增益，K≥2后开始形成稳定优势。
- 原型机制是主体贡献：移除原型后，old注册前和最差类指标均显著下降。
- 对角度量提供小而稳定的总体增益，但最差类差异的置信区间跨0，不能宣称其改善了所有尾部类别。
- 本报告只解释状态矩阵的old侧结果；新类注册、调和均值和遗忘结论以Stage2-C完整矩阵为准。
