...
SOURCE_BASENAME=d92_qic_g0_source_82ce7476_20260817_v2
SOURCE_ROOT="$RUNS/$SOURCE_BASENAME"
SOURCE_ARCHIVE="$RUNS/$SOURCE_BASENAME.tar.gz"
RUN_ROOT="$RUNS/$RUN_ID"
LOG_ROOT="$REMOTE_ROOT/logs/$RUN_ID"
LAUNCH_BASENAME=d92_qic_g0_launch_82ce7476_20260817_v2
PYTHON=/home/szu2070436088/.conda/envs/CVS-RFFI/bin/python

test -f "$SOURCE_ARCHIVE"
test "$(sha256sum "$SOURCE_ARCHIVE" | awk '{print $1}')" = "802a52557657d6d415992192fd546fe564495ff71354a7890807645bb071113a"
test "$(stat -c '%s' "$SOURCE_ARCHIVE")" = "218553"
