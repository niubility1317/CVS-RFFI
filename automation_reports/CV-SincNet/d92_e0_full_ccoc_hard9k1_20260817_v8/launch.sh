...
source_root="$project/runs/d92_ccoc_hard9_k1_source_4e267130_20260817_v8"
runtime_archive="$project/runs/d92_ccoc_hard9_k1_source_4e267130_20260817_v8.tar.gz"
driver="$project/runs/d92_ccoc_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_ccoc_hard9_k1_20260817_v8"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_ccoc_hard9_k1_v8.json"
runner="$code_root/scripts/run_d92_ccoc_hard9_k1.py"
source_manifest="$code_root/D92_CCOC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=3463160224e8586598ae5286ac4b7abb689b56dfa80ec24cbf27e6e4087d16e1
archive_size_bytes=310335
