...
run_id=d92_e0_full_d42_qic_hard9k1_20260817_v2
fresh_run_retry=false
source_root="$project/runs/d92_qic_hard9_k1_source_6969796f_20260817_v2"
runtime_archive="$project/runs/d92_qic_hard9_k1_source_6969796f_20260817_v2.tar.gz"
driver="$project/runs/d92_qic_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_qic_hard9_k1_20260817_v2"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_qic_hard9_k1_v2.json"
runner="$code_root/scripts/run_d92_qic_hard9_k1.py"
source_manifest="$code_root/D92_QIC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=46cd187aeb902eaa5adc8ab79777e6f2a9b94bf0aa85009e85cadd65593175e1
archive_size_bytes=320955
