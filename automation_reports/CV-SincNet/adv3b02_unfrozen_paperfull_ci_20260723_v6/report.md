...
- 状态：`STOPPED_EARLY_RUNTIME_ABI_FAILURE / NO_PERFORMANCE_RESULT`
...
- v6首个package完整验证PASS并产生1个package receipt；CSIL predictor因远端NumPy/Torch ABI桥失败，0cell/prediction/score，无性能结果，矩阵未授权，只读封存。
