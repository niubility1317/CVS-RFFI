"""Publish 25 canonical Stage2-B v3 scoring sidecars for fresh v12."""
...
def _validate_published_artifact(
    *,
    ...
    if (
        ...
        raise ValueError("published Stage2-B truth identity drift")
    if (
...
def main() -> int:
    ...
    sidecar_root = args.output_root / "artifacts" / "sidecars" / "stage2b"
        ...
        for seed in METHOD_SEEDS:
            ...
            command = [
                ...
                str(
                    ...
                    / "code"
                    / "scripts"
                    / "build_full_ablation_stage2b_scoring_sidecar.py"
                ),
    ...
    summary = {
        "schema": "cvs.stage2.v12.stage2b_sidecar_completion.v1",
