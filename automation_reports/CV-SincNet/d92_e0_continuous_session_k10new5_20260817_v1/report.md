...
| archive | `171172`B，SHA256=`1d8a91e5c7a1332c44289915de6d082ce22743cf155f13f461eb6230aa1da4b8` |
| launch.sh | `2294`B，SHA256=`cf6af9203533d26a143e2b3713c49971948b827ea180efe8c61fdcd9789142f7` |
...
- partial artifacts已取回：`E:/type10-7/local_artifacts/d92_e0_continuous_session_k10new5_20260817_v1/`，包含`runtime/`、`output/`、`logs/`、`launch.out`、`launch.err`、`launch.sh`和远端`release/`副本。
