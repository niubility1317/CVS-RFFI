...
source_root="$project/runs/d92_ccoc_hard9_k1_source_fe9033be_20260817_v2"
runtime_archive="$project/runs/d92_ccoc_hard9_k1_source_fe9033be_20260817_v2.tar.gz"
driver="$project/runs/d92_ccoc_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_ccoc_hard9_k1_20260817_v2"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_ccoc_hard9_k1_v2.json"
runner="$code_root/scripts/run_d92_ccoc_hard9_k1.py"
source_manifest="$code_root/D92_CCOC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=4f75acdfde68e6879e8fb8199bf8b3869baea8a262da1626731465a79697f988
archive_size_bytes=314210
