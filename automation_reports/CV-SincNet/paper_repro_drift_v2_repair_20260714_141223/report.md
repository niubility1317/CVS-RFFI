...
- 当前状态：`CANONICAL_MEAN_V1_FIXED_AGGREGATE_REPRODUCED`
...
## 2026-07-14 17:13五seed最终结论

- 五个训练、queue及launcher均已自然退出，`metrics.json`与`PAPER-EVAL-SUMMARY`均为5/5，远端硬错误0。完整读取5×200=1000条epoch记录及15个日志/调度文件共3495行，无缺失epoch或硬错误。
- 正式五seed epoch200 final=`72.75±5.93%`，相对论文v2`73.54%`差`-0.79pp`，五seed均值达到±2pp复现阈值。seed范围64.44%–78.68%，因此总体均值复现成立，但随机种子稳定性仍是明确限制。

|seed|aggregate final|相对73.54/pp|1-19|19-2|2-1|2-19|20-1|7-14|8-8|epoch200 loss/MSE/FN|z_tx/z_rx norm|
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
|1337|77.43|+3.89|67.25|79.50|93.17|76.33|69.25|82.17|74.33|0.33/-38.28/38.31|31.34/0.91|
|2024|64.44|-9.10|55.08|79.75|80.58|52.00|48.33|75.33|60.00|0.51/-29.31/29.34|31.68/0.89|
|3407|69.14|-4.40|65.00|77.92|75.17|67.08|56.17|67.83|74.83|0.46/-35.71/35.94|88.79/2.00|
|4242|78.68|+5.14|71.83|80.42|90.25|67.83|68.42|93.67|78.33|0.37/-36.66/36.71|64.55/1.20|
|7777|74.08|+0.54|62.67|75.75|80.25|64.00|74.25|79.67|82.00|0.42/-33.98/34.01|50.29/0.95|
|五seed均值|72.75|-0.79|64.37|78.67|83.88|65.45|63.28|79.73|73.90|—|—|

- 用户指定将该配置固定为唯一DRIFT论文复现版本。唯一支持入口改为`code/scripts/launch_drift_paper_reproduction.sh`，版本标识`mean_v1`；旧original/repaired/fixopt、sum/cap discovery和V206临时候选launcher从可执行代码面删除。历史报告、日志、metrics和snapshots保留为审计证据，不再是支持版本。
