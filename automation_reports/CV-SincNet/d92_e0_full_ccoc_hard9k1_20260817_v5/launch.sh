...
source_root="$project/runs/d92_ccoc_hard9_k1_source_7856314d_20260817_v5"
runtime_archive="$project/runs/d92_ccoc_hard9_k1_source_7856314d_20260817_v5.tar.gz"
driver="$project/runs/d92_ccoc_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_ccoc_hard9_k1_20260817_v5"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_ccoc_hard9_k1_v5.json"
runner="$code_root/scripts/run_d92_ccoc_hard9_k1.py"
source_manifest="$code_root/D92_CCOC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=88d4600a4dbf494bfd9dcaf3fecb56fd5f8a45296e03bce0cd65eeb541acddfc
archive_size_bytes=308772
