...
source_root="$project/runs/d92_e0d_source_snapshot_20260811_v1"
code_root="$source_root/code"
runtime_archive="$source_root/d92_e0d_runtime_closure_7d11a701.tar.gz"
context="$project/runs/d131_d92_lite160_qtie_target125_20260804_r3/prepared/target125_context.json"
method_lock="$source_root/configs/stage2_d92_e0d_5arm_hard12v2_v1.json"
smoke="$project/runs/d92_e0d_truthfree_smoke_20260811_v1"
output="$project/runs/d92_e0d_5arm_hard12v2_20260811_v1"
logs="$project/logs/d92_e0d_5arm_hard12v2_20260811_v1"

test -f "$runtime_archive"
test "$(sha256sum "$runtime_archive" | awk '{print $1}')" = \
  "36fc9df5e174ecd87863dcb6663afb6875d5f07ca6d17282648adfa38a7f32df"
test -f "$method_lock"
...
test -f "$code_root/cvsrffi/__init__.py"
test -f "$code_root/scripts/probe_d81_ground_nuisance_cauchy_center.py"
test -f "$code_root/scripts/probe_d92_registration_balanced_covariance.py"
mkdir -p "$logs"
cd "$code_root"
