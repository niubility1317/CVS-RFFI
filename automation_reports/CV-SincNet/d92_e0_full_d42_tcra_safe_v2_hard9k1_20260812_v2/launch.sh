...
source_root="$project/runs/d92_tcra_safe_v2_hard9_source_b66644db_20260812_v2"
code_root="$source_root/code"
runtime_archive="$source_root/d92_tcra_safe_v2_hard9_runtime_b66644db.tar.gz"
...
output="$project/runs/d92_e0_full_d42_tcra_safe_v2_hard9k1_20260812_v2"
logs="$project/logs/d92_e0_full_d42_tcra_safe_v2_hard9k1_20260812_v2"

require_file() { test -f "$1" || { printf 'required file missing: %s\n' "$1" >&2; exit 64; }; }
require_file "$runtime_archive"
test "$(sha256sum "$runtime_archive" | awk '{print $1}')" = "2586ead2ff1d9b3822e8772c26674b1a91ac3cd0e847c2aa76b42bd03c25ce0c"
