...
source_root="$project/runs/d92_ccoc_hard9_k1_source_2b844de5_20260817_v3"
runtime_archive="$project/runs/d92_ccoc_hard9_k1_source_2b844de5_20260817_v3.tar.gz"
driver="$project/runs/d92_ccoc_hard9_k1_driver_${run_id}.sh"
output_root="$project/runs/d92_ccoc_hard9_k1_20260817_v3"
logs_root="$project/logs/${run_id}"
code_root="$source_root/code"
config="$source_root/configs/stage2_d92_ccoc_hard9_k1_v3.json"
runner="$code_root/scripts/run_d92_ccoc_hard9_k1.py"
source_manifest="$code_root/D92_CCOC_HARD9_K1_SOURCE_MANIFEST.sha256"
archive_sha256=05d6199d724d96a596723524f34d4cbb67ff8cfbd6f0ada61deef5b7c0364cb1
archive_size_bytes=308577
