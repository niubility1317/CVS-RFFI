...
def build_augmentor(**kwargs) -> RFFIAugmentor:
    ...
    Compatibility note:
    Some training scripts pass sample_rate_hz, but the current
    RFFIAugmentor does not consume it. We silently discard it here
    to keep old/new train.py versions compatible.
    """
