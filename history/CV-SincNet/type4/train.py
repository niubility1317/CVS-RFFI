...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        # save
        torch.save(model.state_dict(), os.path.join(WEIGHT_DIR, "last_model_run1_Aug_CL3.pth"))
        if test_acc > best_acc:
            best_acc = test_acc
            torch.save(model.state_dict(), os.path.join(WEIGHT_DIR, "best_model_run1_Aug_CL3.pth"))
