"""ECRS physical solver retained from the 2026-09-07 response-surface revision.

This module contains no checkpoint, dataset, label, or mutable query state.
Real stacked Jacobians preserve the real gain/phase/CFO nuisance model.
"""
