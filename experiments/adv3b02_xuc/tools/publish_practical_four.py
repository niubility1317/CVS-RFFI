...
active={};receipts=[]
for variant in ('full_noeq','full_zf','residual_noeq','full_mmse'):
    ...
    config=release/('configs/rc4_practical_'+variant+'_20260918.json')
...
def main():
    ...
    release='daot_rc4_practical4_20260918_'+commit[:10];archive=a.output/(release+'.tar')
