...
|T-06|Tweak未公开|激活、BN、初始化、挖掘细则|`strict_method.json`、validator、测试|pending|TDD|`UNPUBLISHED_DEFAULT`。|
|H-01|Hu p.1490,p.1492|预处理接口与Welch-PSD|`preprocess.py`、`representation.py`、测试|pending|TDD|Welch细节为`UNPUBLISHED_DEFAULT`。|
|H-02|Hu Fig.6,p.1491|可审计ResNet18/attention/分支结构|`architecture.py`、`model.py`、测试|pending|TDD|结构歧义为`UNPUBLISHED_DEFAULT`。|
...
|H-06|Hu式(32),p.1496|25样本TX微调和冻结状态|`finetune.py`、测试|pending|TDD|冻结策略为`UNPUBLISHED_DEFAULT`。|
