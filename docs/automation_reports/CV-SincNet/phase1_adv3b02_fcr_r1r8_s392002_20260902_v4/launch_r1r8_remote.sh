...
CODE_ROOT="${ROOT}/releases/phase1_adv3b02_fcr_r1r8_s392002_20260902_v4"
...
for index in 1 2 3 4 5 6 7 8; do
  ...
  nohup env RUN_ID="${RUN_ID}" OUTPUT_ROOT="${job_root}" ROOT="${ROOT}" CODE_ROOT="${CODE_ROOT}" GPU="${gpu}" SEED=392002 \
