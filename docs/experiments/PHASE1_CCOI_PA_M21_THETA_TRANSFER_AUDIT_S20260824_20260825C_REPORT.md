...
|设计要求|落地行为|验证证据|
|---|---|---|
|权重独立retro audit|按TX×RX×day×eq×capture block拆分fit/audit/guard；audit不进入训练和选模|`split_manifest.json`、role访问负测|
|C1′/C4′同容量对照|共享初始化模板、参数量、训练step和L_s输入；只改变conditioned/匹配/DiD/holdout机制|两份architecture artifact、训练摘要、参数量测试|
|V3 sidecar契约|显式保存token length、stride、q维度、码本、PA map contract等无参数语义；V2只能显式迁移|V3 round-trip及错误contract负测|
|四fold raw-disjoint holdout|每个fold重新遮罩Core90 PA map，support与holdout原始采样区间不重叠|四fold/raw-mask单测、factor artifact|
|独立support bank|F2—F6只从V_select_fit构造；metadata硬约束后按seed确定选择，不读取q且无fallback|关系构造测试、fallback_count=0|
|共同anchor统计|F0/F2/F3/F5均限制到F2∩F3∩F5，按4fold等权macro NMSE|factor artifact中的common_anchor和fold policy|
|有限不确定性分析|3个mapping seed×3个head seed×2个satellite seed|factor和decision artifact|
|q与码本审计|ordered、token-shuffle、DeepSets、条件probe和hard/soft codebook诊断|`q_conditional_probe.json`|
|精确物理配对审计|同TX/RX/day/fold候选池上的Recall@1/5、rank、MRR、AUC和margin|`m0_exact_pair_retrieval.json`|
|LOTO residual|6个TX逐一整类留出，公共模型和residual head均不读取held-out TX训练样本|`loto_residual_audit.json`及held-out TX负测|
|两阶段状态机|只有A_PASS才允许训练truth-blind gate；A_FAIL输出合法NOT_RUN artifact|两个gate artifact和`decision_manifest.json`|
|不可覆盖发布|全新run ID、真实checkpoint无query smoke、输出冲突即拒绝|launcher测试、smoke日志和正式run目录|
...
- 追踪状态：40项`verified`、0项`implemented`、1项`rejected`、1项`deferred`、0项`pending`、0项`blocked`。
...
#### 11.2.1逐mapping seed核心比较

|候选|mapping seed|F3 NMSE|G30：F3相对F0改善|G30 CI下界|G35：F3相对F5改善|G35 CI下界|D32：F3相对F2退化|
|---|---:|---:|---:|---:|---:|---:|---:|
|C1′|20261326|0.244959|42.5437%|39.3300%|11.0286%|6.8758%|14.6059%|
|C1′|20261327|0.241837|43.5265%|39.8468%|12.3872%|8.7629%|14.4573%|
|C1′|20261328|0.244396|42.8789%|39.4130%|11.8667%|7.4041%|15.5558%|
|C4′|20261326|0.194944|21.7431%|16.2385%|6.1794%|1.3509%|14.7101%|
|C4′|20261327|0.191304|23.2533%|19.2005%|8.8626%|5.0761%|12.7918%|
|C4′|20261328|0.193039|22.8945%|18.1916%|8.5822%|4.7287%|13.5591%|

三个C4′mapping seed均通过G30和G35方向与CI条件，也均违反D32≤10%。失败不是单个候选映射造成的偶然波动。

#### 11.2.2逐head seed敏感性

|候选|mapping seed|head seed|G30|G30 CI下界|G35|G35 CI下界|D32|
|---|---:|---:|---:|---:|---:|---:|---:|
|C1′|20261326|20261426|42.0327%|39.3300%|10.3253%|6.9646%|15.7616%|
|C1′|20261326|20261427|42.3025%|39.4116%|10.1853%|6.8758%|12.7187%|
|C1′|20261326|20261428|43.2958%|40.3355%|12.5754%|9.4497%|15.3374%|
|C1′|20261327|20261426|42.7469%|39.8468%|12.6965%|9.5175%|15.6304%|
|C1′|20261327|20261427|43.2695%|40.3666%|12.0237%|8.7629%|13.4946%|
|C1′|20261327|20261428|44.5632%|41.4468%|12.4415%|9.1873%|14.2470%|
|C1′|20261328|20261426|42.9582%|40.0652%|13.2088%|10.0918%|15.0446%|
|C1′|20261328|20261427|42.3970%|39.4130%|10.8764%|7.4041%|16.0677%|
|C1′|20261328|20261428|43.2814%|40.2675%|11.5148%|8.3210%|15.5552%|
|C4′|20261326|20261426|22.2985%|19.2223%|6.6661%|3.3608%|15.1237%|
|C4′|20261326|20261427|20.1972%|16.2385%|4.4152%|1.3509%|16.5900%|
|C4′|20261326|20261428|22.7335%|18.8821%|7.4569%|4.3815%|12.4165%|
|C4′|20261327|20261426|23.4920%|20.2163%|7.9040%|5.0761%|13.6096%|
|C4′|20261327|20261427|22.9929%|19.2005%|9.7854%|7.2064%|13.6508%|
|C4′|20261327|20261428|23.2749%|19.3746%|8.8985%|5.8790%|11.1148%|
|C4′|20261328|20261426|23.6292%|20.4818%|9.5123%|7.0445%|12.9729%|
|C4′|20261328|20261427|21.8990%|18.1916%|7.8162%|4.7287%|14.6554%|
|C4′|20261328|20261428|23.1552%|19.5538%|8.4182%|5.5065%|13.0489%|

C4′的9个head中G30全部为正且CI下界大于0；G35全部为正，其中1个head为4.4152%，未达到单点5%，但mapping-level平均仍达到6.1794%。9个head的D32全部超过10%，所以跨receiver失败对head初始化稳定。

#### 11.2.3四fold详细NMSE

下表对3个mapping seed和3个head seed取均值，每个cell仍使用该fold的common anchors。

|候选|Row|fold0|fold1|fold2|fold3|
|---|---|---:|---:|---:|---:|
|C1′|F0|0.442971|0.294401|0.340762|0.563204|
|C1′|F1|0.179577|0.191765|0.214094|0.256443|
|C1′|F2|0.172267|0.195256|0.222016|0.258570|
|C1′|F3|0.209920|0.215167|0.262038|0.287798|
|C1′|F4|0.176407|0.195452|0.237050|0.255534|
|C1′|F5|0.261988|0.263050|0.265352|0.308136|
|C1′|F6|0.187354|0.203573|0.248542|0.282622|
|C1′|F8|0.177852|0.191892|0.208700|0.248636|
|C1′|F9|0.445367|0.294953|0.338703|0.561308|
|C4′|F0|0.279492|0.179781|0.332698|0.222255|
|C4′|F1|0.142459|0.147022|0.177353|0.196262|
|C4′|F2|0.148626|0.153797|0.175167|0.199166|
|C4′|F3|0.176715|0.176037|0.204971|0.214661|
|C4′|F4|0.151698|0.155839|0.182452|0.201462|
|C4′|F5|0.197776|0.194824|0.220890|0.225621|
|C4′|F6|0.158330|0.172966|0.191347|0.211877|
|C4′|F8|0.158739|0.159557|0.176282|0.199737|
|C4′|F9|0.445367|0.294953|0.338703|0.561308|

4个fold中F3均劣于F2；fold0差距最大，说明位置仍影响绝对难度，但A_FAIL不是单一fold造成的。
...
|epoch|C1′ V_select准确率|C1′总损失|C4′ V_select准确率|C4′总损失|
|---:|---:|---:|---:|---:|
|1|54.8181%|2.32897|52.3185%|2.45155|
|5|77.0154%|1.52757|80.7274%|1.57517|
|10|87.3641%|1.26579|88.7764%|1.29852|
|20|91.0636%|1.12157|91.5136%|1.14447|
|30|91.7385%|1.07139|91.9260%|1.10077|
|40|91.8010%|1.05047|92.3010%|1.07076|
|50|92.5634%|1.01898|92.8134%|1.04549|
|60|92.4384%|1.00325|92.7509%|1.02879|
